...
<header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 pb-6">
...
<h1 className="text-slate-900 text-3xl md:text-4xl font-black leading-tight tracking-tight">Facture #INV-2024-001</h1>
<p className="text-slate-500 text-base">Date d'émission : 24 Octobre 2024</p>
</div>
...
<p className="text-slate-900 text-lg font-bold">Client</p>
</div>
<div className="space-y-1">
<p className="text-slate-900 font-semibold">Jane Doe</p>
...
<p className="text-slate-900 text-lg font-bold">Artisan</p>
</div>
<div className="space-y-1">
<p className="text-slate-900 font-semibold">Ahmed Mansouri</p>
<p className="text-slate-500 text-sm leading-relaxed">
...
<h3 className="text-lg font-bold text-slate-900 mb-4">Récapitulatif de la Prestation</h3>
...
<div>
<p className="text-sm font-bold text-slate-900">Date de réalisation</p>
<p className="text-slate-500 text-sm">Mardi 22 Octobre 2024</p>
</div>
</div>
<div className="flex items-start gap-3">
...
<p className="text-slate-500 text-sm">Paris (75002) â†’ Boulogne-Billancourt (92100)</p>
<p className="text-xs text-slate-400 mt-1">Distance estimée : 12.5 km</p>
</div>
</div>
</div>
<div className="relative h-40 md:h-full min-h-[140px] rounded-lg overflow-hidden bg-slate-100">
...
<div className="bg-white/90 px-3 py-1.5 rounded-full shadow-lg border border-primary/20">
...
<td className="px-6 py-4 text-right text-slate-700">450,00 €</td>
<td className="px-6 py-4 text-right font-semibold text-slate-900">450,00 €</td>
</tr>
<tr>
<td className="px-6 py-4">
<p className="text-slate-900 font-semibold">Surcharge de Distance</p>
<p className="text-xs text-slate-500">Calculé sur 12.5 km</p>
</td>
<td className="px-6 py-4 text-center text-slate-700">1</td>
<td className="px-6 py-4 text-right text-slate-700">25,00 €</td>
<td className="px-6 py-4 text-right font-semibold text-slate-900">25,00 €</td>
</tr>
<tr>
<td className="px-6 py-4">
<p className="text-slate-900 font-semibold">Objets Fragiles / Lourds</p>
...
<td className="px-6 py-4 text-right text-slate-700">40,00 €</td>
<td className="px-6 py-4 text-right font-semibold text-slate-900">80,00 €</td>
</tr>
<tr>
<td className="px-6 py-4">
<p className="text-slate-900 font-semibold">Montage de meubles</p>
<p className="text-xs text-slate-500">Armoire chambre + Lit King Size</p>
</td>
<td className="px-6 py-4 text-center text-slate-700">2</td>
<td className="px-6 py-4 text-right text-slate-700">30,00 €</td>
<td className="px-6 py-4 text-right font-semibold text-slate-900">60,00 €</td>
</tr>
</tbody>
</table>
</div>
