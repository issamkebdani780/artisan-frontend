...
<p className="text-slate-500 text-base">Date d'Ã©mission : 24 Octobre 2024</p>
</div>
...
<h3 className="text-lg font-bold text-slate-900 mb-4">RÃ©capitulatif de la Prestation</h3>
...
<p className="text-slate-500 text-sm">DÃ©mÃ©nagement Complet T3 (45mÂ²)</p>
</div>
</div>
<div className="flex items-start gap-3">
<span className="material-symbols-outlined text-primary">calendar_today</span>
<div>
<p className="text-sm font-bold text-slate-900">Date de rÃ©alisation</p>
...
<div>
<p className="text-sm font-bold text-slate-900">ItinÃ©raire</p>
<p className="text-slate-500 text-sm">Paris (75002) Ã¢â€ â€™ Boulogne-Billancourt (92100)</p>
...
<p className="text-slate-900 font-semibold">Forfait DÃ©mÃ©nagement de base</p>
