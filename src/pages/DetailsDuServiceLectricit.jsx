...
<span className="text-sm font-bold text-primary bg-primary/10 px-3 py-1 rounded-full">À partir de 50 DA</span>
</div>
...
<span className="text-sm font-bold text-primary bg-primary/10 px-3 py-1 rounded-full">À partir de 45 DA</span>
</div>
