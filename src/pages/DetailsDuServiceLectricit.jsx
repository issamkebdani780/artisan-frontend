...
<span className="text-sm font-bold text-primary bg-primary/10 px-3 py-1 rounded-full">ÃDA partir de 50â‚¬</span>
</div>
...
<span className="text-sm font-bold text-primary bg-primary/10 px-3 py-1 rounded-full">ÃDA partir de 45â‚¬</span>
</div>
