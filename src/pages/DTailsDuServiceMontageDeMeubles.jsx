...
const DTailsDuServiceMontageDeMeubles = () => {
  return (
    <>
...
{/*  Navigation  */}
<header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 dark:border-slate-800 px-4 md:px-10 lg:px-40 py-3 bg-white dark:bg-background-dark sticky top-0 z-50">
...
<h2 className="text-slate-900 dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">TaskService</h2>
</div>
<nav className="hidden md:flex items-center gap-9">
<a className="text-slate-700 dark:text-slate-300 text-sm font-medium hover:text-primary" href="#">Services</a>
<a className="text-slate-700 dark:text-slate-300 text-sm font-medium hover:text-primary" href="#">Devenir Taskeur</a>
<a className="text-slate-700 dark:text-slate-300 text-sm font-medium hover:text-primary" href="#">Connexion</a>
</nav>
</div>
...
<input className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-r-lg text-slate-900 dark:text-slate-100 focus:outline-0 focus:ring-0 border-none bg-slate-100 dark:bg-slate-800 h-full placeholder:text-slate-500 px-4 pl-2 text-base font-normal" placeholder="Rechercher un service" value=""/>
</div>
</label>
...
<h2 className="text-slate-900 dark:text-white text-3xl font-bold">Nos meilleurs artisans</h2>
...
<span className="text-slate-900 dark:text-white ml-1 font-bold">4.9</span>
...
<div className="flex items-center text-yellow-500">
<span className="material-symbols-outlined text-[18px] fill-current">star</span>
<span className="text-slate-900 dark:text-white ml-1 font-bold">5.0</span>
...
<div className="flex items-center text-yellow-500">
<span className="material-symbols-outlined text-[18px] fill-current">star</span>
<span className="text-slate-900 dark:text-white ml-1 font-bold">4.8</span>
...
{/*  Footer  */}
<footer className="bg-white dark:bg-background-dark border-t border-slate-200 dark:border-slate-800 px-4 md:px-10 lg:px-40 py-12">
...
export default DTailsDuServiceMontageDeMeubles;
