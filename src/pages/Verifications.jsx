...
<input className="w-full pl-10 pr-4 py-2 bg-slate-100 dark:bg-slate-800 border-none rounded-xl text-sm focus:ring-2 focus:ring-purple-500" placeholder="Rechercher un artisan..." type="text"/>
</div>
<div className="flex items-center gap-2">
...
<div className="p-8">
<div className="mb-8">
<h1 className="text-3xl font-black tracking-tight text-slate-900 dark:text-white">Vérifications en attente</h1>
<p className="text-slate-500 dark:text-slate-400 mt-2">Validez l'identité et les documents professionnels des artisans pour permettre l'accès à la plateforme.</p>
</div>
{/*  Tabs  */}
...
<th className="px-6 py-4 text-sm font-bold text-slate-600 dark:text-slate-400">Statut Documents</th>
...
<td className="px-6 py-4">
<span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300">
...
<td className="px-6 py-4 text-right">
<button className="text-sm font-bold text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">Relancer</button>
</td>
</tr>
{/*  Row 4  */}
<tr className="hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-colors">
...
{/*  Footer  */}
<footer className="mt-auto p-8 border-t border-slate-200 dark:border-slate-800 text-center text-slate-400 text-sm">
