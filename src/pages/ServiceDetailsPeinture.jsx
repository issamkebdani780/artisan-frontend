...
<h2 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">Peinture</h2>
</div>
...
<button className="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:text-primary transition-colors">
...
{/*  Hero Section  */}
<div className="overflow-hidden rounded-xl bg-white dark:bg-slate-900 shadow-sm border border-primary/5">
...
<div className="flex flex-col items-center justify-center rounded-xl border border-primary/10 bg-white dark:bg-slate-900 p-6 shadow-sm">
<span className="text-sm font-medium text-slate-500 dark:text-slate-400">Surfaces peintes</span>
<p className="mt-1 text-3xl font-black text-primary">10k+ m²</p>
</div>
<div className="flex flex-col items-center justify-center rounded-xl border border-primary/10 bg-white dark:bg-slate-900 p-6 shadow-sm">
<span className="text-sm font-medium text-slate-500 dark:text-slate-400">Satisfaction</span>
<p className="mt-1 text-3xl font-black text-primary">99%</p>
</div>
<div className="flex flex-col items-center justify-center rounded-xl border border-primary/10 bg-white dark:bg-slate-900 p-6 shadow-sm">
<span className="text-sm font-medium text-slate-500 dark:text-slate-400">Garantie</span>
...
<div className="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 shadow-sm border border-primary/5 transition-all hover:shadow-md">
...
<p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Finition impeccable pour vos espaces de vie.</p>
</div>
</div>
<div className="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 shadow-sm border border-primary/5 transition-all hover:shadow-md">
...
<p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Redonnez de la luminosité à vos pièces.</p>
</div>
</div>
<div className="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 shadow-sm border border-primary/5 transition-all hover:shadow-md">
...
<p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Pose soignée de revêtements muraux.</p>
</div>
</div>
<div className="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 shadow-sm border border-primary/5 transition-all hover:shadow-md">
...
<p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Protection et esthétique extérieure.</p>
</div>
</div>
</div>
</section>
...
<p className="text-sm text-slate-600 dark:text-slate-400">Plus de 15 ans d'expérience dans le domaine de la rénovation haut de gamme.</p>
</div>
</div>
<div className="flex items-start gap-4 p-4 rounded-xl bg-primary/5 border border-primary/10">
<div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary text-white">
...
<p className="text-sm text-slate-600 dark:text-slate-400">Nous utilisons exclusivement des peintures A+ respectueuses de l'environnement.</p>
</div>
</div>
</div>
</section>
...
<p className="text-sm italic text-slate-600 dark:text-slate-300">"Un travail d'une précision incroyable. L'équipe a été discrète et très propre. Mon salon est métamorphosé !"</p>
...
<p className="text-sm italic text-slate-600 dark:text-slate-300">"Le devis a été respecté à la lettre et le délai aussi. Je recommande vivement pour vos travaux de peinture."</p>
<div className="mt-4 flex items-center gap-3">
...
<h3 className="text-xl font-bold text-slate-900 dark:text-white">Besoin d'un devis gratuit?</h3>
...
<div className="rounded-xl bg-white dark:bg-slate-900 border border-primary/10 p-4 shadow-sm">
...
{/*  Contact Sidebar  */}
<div className="rounded-xl bg-white dark:bg-slate-900 border border-primary/10 p-6 shadow-sm">
...
<footer className="mt-12 border-t border-primary/10 bg-white dark:bg-background-dark py-8">
...
<p className="text-sm text-slate-500 dark:text-slate-400">© 2024 Peinture &amp; Décoration. Tous droits réservés.</p>
</div>
</footer>
</div>
