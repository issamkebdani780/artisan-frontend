...
{/*  Sidebar Navigation  */}
<aside className="w-72 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col h-full">
...
<input className="bg-slate-100 dark:bg-slate-800 border-none rounded-xl text-sm pl-10 pr-4 py-2 w-64 focus:ring-2 focus:ring-primary/50" placeholder="Rechercher une conversation..." type="text"/>
</div>
...
<button className="flex-1 text-xs font-bold py-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400">Non lus</button>
<button className="flex-1 text-xs font-bold py-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400">Favoris</button>
<button className="flex-1 text-[10px] font-bold py-2 rounded-lg bg-red-50 dark:bg-red-900/20 text-red-600 border border-red-100 dark:border-red-900/30 uppercase tracking-tighter">Litiges</button></div>
</div>
<div className="flex-1 overflow-y-auto">
{/*  Active Conversation  */}
<div className="p-4 border-b border-slate-100 dark:border-slate-800 bg-primary/5 border-l-4 border-l-primary cursor-pointer">
...
<h3 className="text-sm font-bold truncate">Jean Dupont</h3><span className="inline-flex items-center px-1.5 py-0.5 rounded-full text-[8px] font-black bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300 uppercase ml-1">Critique</span>
<span className="text-[10px] text-primary font-medium">10:30</span>
</div>
<p className="text-xs text-slate-900 dark:text-slate-100 font-semibold truncate mt-0.5">Bonjour, seriez-vous disponible pour...</p>
<p className="text-[10px] text-slate-400 mt-1 uppercase tracking-wider font-bold">Projet Cuisine</p>
</div>
</div>
</div>
{/*  Other Conversations  */}
<div className="p-4 border-b border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer">
<div className="flex gap-3">
...
{/*  Chat Window  */}
<div className="flex-1 flex flex-col bg-background-light dark:bg-background-dark border-t-4 border-t-red-500/50">
{/*  Chat Header  */}
...
<span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300 uppercase">Litige Critique</span>
<span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300 uppercase">Statut: Ouvert</span>
</div>
...
<span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest bg-slate-100 dark:bg-slate-800 px-3 py-1 rounded-full">Lundi 23 Octobre</span>
</div>
{/*  Message Received  */}
...
<div className="w-72 bg-white dark:bg-slate-900 border-l border-slate-200 dark:border-slate-800 hidden xl:flex flex-col">
<div className="p-6 text-center border-b border-slate-100 dark:border-slate-800">
<div className="w-20 h-20 rounded-full bg-slate-200 overflow-hidden mx-auto mb-4 border-4 border-slate-50 dark:border-slate-800">
...
<p className="text-[9px] text-slate-400">2.4 MB �DA� 22 Oct</p>
</div>
</div>
<div className="flex items-center gap-3 p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg cursor-pointer">
...
<p className="text-[9px] text-slate-400">1.1 MB �DA� Hier</p>
</div>
</div>
</div>
</div>
...
<button className="w-full py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-bold text-slate-600 dark:text-slate-400 hover:bg-slate-100 transition-colors">
