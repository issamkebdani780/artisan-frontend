...
<span className="text-xs font-medium text-slate-600">Revenus (€)</span>
</div>
</div>
</div>
<div className="relative h-64 w-full flex items-end gap-2 sm:gap-4 md:gap-8 pt-6 border-l border-b border-slate-100 ml-8">
{/*  Y-Axis Labels  */}
...
<div className="w-full bg-blue-100 rounded-t-lg transition-all duration-300 group-hover:bg-blue-500/40" ></div>
<span className="text-[10px] font-bold text-slate-400 uppercase">Mai</span>
</div>
<div className="flex-1 flex flex-col items-center gap-2 h-full justify-end group">
<div className="w-full bg-blue-200 rounded-t-lg transition-all duration-300 group-hover:bg-blue-500/40" ></div>
<span className="text-[10px] font-bold text-slate-400 uppercase">Juin</span>
</div>
<div className="flex-1 flex flex-col items-center gap-2 h-full justify-end group">
<div className="w-full bg-blue-300 rounded-t-lg transition-all duration-300 group-hover:bg-blue-500/40" ></div>
<span className="text-[10px] font-bold text-slate-400 uppercase">Juil</span>
</div>
<div className="flex-1 flex flex-col items-center gap-2 h-full justify-end group">
<div className="w-full bg-blue-400 rounded-t-lg transition-all duration-300 group-hover:bg-blue-500/40" ></div>
...
<p className="text-sm font-bold text-slate-900 mt-1">850 €</p>
</div>
</div>
{/*  Mission 3  */}
<div className="p-6 flex items-center gap-4 hover:bg-slate-50 transition-colors">
...
<p className="text-sm font-bold text-slate-900 mt-1">320 €</p>
</div>
</div>
</div>
</div>
