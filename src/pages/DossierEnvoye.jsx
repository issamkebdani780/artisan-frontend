...
<p className="mt-4 text-lg text-slate-600">
          Votre demande est en cours de révision par notre équipe. Vous recevrez une notification dès que votre profil sera validé.
        </p>
</div>
...
<h2 className="text-sm font-semibold text-slate-700 uppercase tracking-wider text-left">Résumé des documents soumis</h2>
</div>
...
<span className="text-slate-700 font-medium">Pièce d'identité</span>
</div>
...
<span className="text-slate-700 font-medium">Assurance Décennale</span>
</div>
<span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800">
<span className="w-1.5 h-1.5 rounded-full bg-amber-500 mr-1.5"></span>
              En cours de révision
...
<span className="text-slate-700 font-medium">Diplômes &amp; Qualifications</span>
</div>
<span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800">
<span className="w-1.5 h-1.5 rounded-full bg-amber-500 mr-1.5"></span>
              En cours de révision
