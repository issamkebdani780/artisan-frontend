...
{/*  Justification  */}
<div className="flex flex-col gap-2">
<label className="text-slate-700 text-sm font-semibold">Explication d̩taill̩e / Justification</label>
<textarea className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-slate-900 focus:ring-2 focus:ring-primary focus:border-primary transition-all resize-none" placeholder="D̩crivez pr̩cis̩ment les faits et les raisons pour lesquelles vous contestez cet avertissement..." rows="6"></textarea>
