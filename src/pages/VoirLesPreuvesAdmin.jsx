      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-8 max-w-4xl mx-auto w-full">
        ...
        <div className="flex flex-wrap justify-between items-start gap-4">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-slate-500 text-base font-normal">RÃ©fÃ©rence de l'avertissement : <span className="font-mono font-semibold">#ADV-2023-0892</span></p>
          </div>
        ...
        <div className="mt-6 p-6 rounded-xl bg-white border border-slate-200 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-1 flex-col gap-2 rounded-xl p-6 bg-red-50 border border-red-100">
              <p className="text-red-700 text-sm font-bold uppercase tracking-wider">GravitÃ©</p>
              <p className="text-red-800 tracking-tight text-2xl font-black">Ã‰levÃ©e</p>
            </div>
            <div className="flex flex-1 flex-col gap-2 rounded-xl p-6 bg-slate-50 border border-slate-100">
              <p className="text-slate-500 text-sm font-bold uppercase tracking-wider">DÃ©lai de rÃ©ponse restant</p>
              <p className="text-slate-900 tracking-tight text-2xl font-black">5 jours ouvrÃ©s</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="group relative flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white transition-all hover:shadow-md">
              ...
              <div className="p-4">
                ...
                <p className="mt-2 text-sm text-slate-600">Absence de balisage de sÃ©curitÃ© autour de la fosse d'excavation principale.</p>
              </div>
            </div>
            <div className="group relative flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white transition-all hover:shadow-md">
              <div className="aspect-video w-full overflow-hidden bg-slate-200">
              ...
              <div className="p-4">
                ...
                <p className="mt-2 text-sm text-slate-600">Extincteurs dont la date de validitÃ© est expirÃ©e depuis plus de 6 mois.</p>
              </div>
            </div>
          </div>
