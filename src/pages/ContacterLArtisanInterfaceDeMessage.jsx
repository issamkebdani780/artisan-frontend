...
{/*  Top Navigation Bar  */}
<header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/80 backdrop-blur-md px-4 md:px-10 lg:px-40 py-3">
<div className="flex items-center justify-between max-w-[1200px] mx-auto">
<div className="flex items-center gap-4">
<div className="text-primary flex items-center justify-center">
<span className="material-symbols-outlined text-3xl">construction</span>
</div>
<h2 className="text-slate-900 text-xl font-bold tracking-tight">Artisanat</h2>
</div>
<nav className="hidden md:flex items-center gap-8">
<a className="text-slate-600 hover:text-primary transition-colors text-sm font-medium" href="#">Accueil</a>
<a className="text-slate-600 hover:text-primary transition-colors text-sm font-medium" href="#">Artisans</a>
<a className="text-slate-600 hover:text-primary transition-colors text-sm font-medium" href="#">Tarifs</a>
</nav>
<div className="flex items-center gap-3">
<button className="flex items-center justify-center rounded-lg h-10 w-10 bg-slate-100 text-slate-700 hover:bg-slate-200 transition-all">
...
<span className="material-symbols-outlined text-xs">chevron_right</span>
<span className="text-slate-900 font-medium">Contacter Ahmed Mansouri</span>
</nav>
...
<label className="text-sm font-semibold text-slate-700" htmlFor="message">Votre message</label>
<textarea className="w-full rounded-lg border-slate-200 bg-white p-4 focus:ring-2 focus:ring-primary focus:border-transparent text-slate-900 transition-all placeholder:text-slate-400" id="message" placeholder="Bonjour Ahmed, j'aimerais discuter d'un projet de menuiserie sur mesure..." rows="8"></textarea>
</div>
{/*  Attachments  */}
...
<span className="text-sm font-medium text-slate-600 group-hover:text-primary">Photos</span>
</button>
<button className="flex items-center gap-2 px-4 py-2 rounded-lg border-2 border-dashed border-slate-200 hover:border-primary hover:bg-primary/5 transition-all group">
<span className="material-symbols-outlined text-slate-400 group-hover:text-primary">description</span>
<span className="text-sm font-medium text-slate-600 group-hover:text-primary">Documents</span>
</button>
<button className="flex items-center gap-2 px-4 py-2 rounded-lg border-2 border-dashed border-slate-200 hover:border-primary hover:bg-primary/5 transition-all group">
...
<div className="flex items-center gap-3">
<div className="h-8 w-8 rounded bg-slate-100 flex items-center justify-center text-primary">
...
{/*  Footer Footer  */}
<footer className="mt-auto border-t border-slate-200 bg-white py-10 px-4 md:px-10 lg:px-40">
