...
<span className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">ArtisanDirect</span>
</div>
{/*  Search Bar  */}
...
<input className="block w-full pl-10 pr-3 py-2 border-none bg-slate-100 dark:bg-slate-800 rounded-lg focus:ring-2 focus:ring-primary text-sm" placeholder="Quel service recherchez-vous ?" type="text"/>
</div>
</div>
{/*  Navigation & Actions  */}
...
<span className="text-slate-900 dark:text-white">Recherche</span>
</nav>
</div>
{/*  Main Content Layout  */}
...
<div>
<h2 className="text-lg font-bold text-slate-900 dark:text-white mb-1">Filtres</h2>
...
<input defaultChecked className="h-5 w-5 rounded border-slate-300 dark:border-slate-600 text-primary focus:ring-primary bg-transparent checked:bg-primary" type="checkbox"/>
<span className="text-sm text-slate-700 dark:text-slate-300 group-hover:text-primary transition-colors">Cette semaine</span>
</label>
<label className="flex items-center gap-3 cursor-pointer group">
<input className="h-5 w-5 rounded border-slate-300 dark:border-slate-600 text-primary focus:ring-primary bg-transparent" type="checkbox"/>
<span className="text-sm text-slate-700 dark:text-slate-300 group-hover:text-primary transition-colors">Aujourd'hui</span>
</label>
<label className="flex items-center gap-3 cursor-pointer group">
<input className="h-5 w-5 rounded border-slate-300 dark:border-slate-600 text-primary focus:ring-primary bg-transparent" type="checkbox"/>
<span className="text-sm text-slate-700 dark:text-slate-300 group-hover:text-primary transition-colors">Demain</span>
</label>
<label className="flex items-center gap-3 cursor-pointer group">
<input className="h-5 w-5 rounded border-slate-300 dark:border-slate-600 text-primary focus:ring-primary bg-transparent" type="checkbox"/>
<span className="text-sm text-slate-700 dark:text-slate-300 group-hover:text-primary transition-colors">Ce mois-ci</span>
</label>
</div>
{/*  Other Categories (Inactive Headings)  */}
<div className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer text-slate-600 dark:text-slate-400 mt-4">
...
<div className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer text-slate-600 dark:text-slate-400">
...
<div className="mb-8">
<h1 className="text-3xl font-bold text-slate-900 dark:text-white">Artisans disponibles cette semaine</h1>
<p className="text-slate-500 dark:text-slate-400 mt-2">Trouvez l'expert idéal pour vos travaux urgents parmis nos professionnels certifiés.</p>
</div>
{/*  Results Grid  */}
<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
{/*  Artisan Card 1  */}
<div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden group hover:shadow-lg transition-shadow">
...
<h3 className="font-bold text-lg text-slate-900 dark:text-white">Jean Dupuis</h3>
...
<span className="text-xs font-semibold text-slate-600 dark:text-slate-400">(124 avis)</span>
</div>
...
<button className="px-3 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200 transition-colors">
...
<div>
<div className="flex items-center gap-1.5">
<h3 className="font-bold text-lg text-slate-900 dark:text-white">Marc Lefebvre</h3>
...
<span className="text-xs font-semibold text-slate-600 dark:text-slate-400">(89 avis)</span>
</div>
<div className="flex gap-2">
<button className="flex-1 bg-primary text-white text-sm font-bold py-2 rounded-lg hover:bg-primary/90 transition-colors">Voir le profil</button>
<button className="px-3 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200 transition-colors">
...
<div>
<div className="flex items-center gap-1.5">
<h3 className="font-bold text-lg text-slate-900 dark:text-white">Sophie Martin</h3>
<span className="material-symbols-outlined text-primary text-lg">verified</span>
</div>
...
<span className="text-xs font-semibold text-slate-600 dark:text-slate-400">(215 avis)</span>
</div>
<div className="flex gap-2">
<button className="flex-1 bg-primary text-white text-sm font-bold py-2 rounded-lg hover:bg-primary/90 transition-colors">Voir le profil</button>
<button className="px-3 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200 transition-colors">
...
<div>
<div className="flex items-center gap-1.5">
<h3 className="font-bold text-lg text-slate-900 dark:text-white">Thomas Bernard</h3>
<span className="material-symbols-outlined text-primary text-lg">verified</span>
</div>
...
<span className="text-xs font-semibold text-slate-600 dark:text-slate-400">(54 avis)</span>
</div>
<div className="flex gap-2">
<button className="flex-1 bg-primary text-white text-sm font-bold py-2 rounded-lg hover:bg-primary/90 transition-colors">Voir le profil</button>
<button className="px-3 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200 transition-colors">
...
<div>
<div className="flex items-center gap-1.5">
<h3 className="font-bold text-lg text-slate-900 dark:text-white">Lucas Petit</h3>
<span className="material-symbols-outlined text-primary text-lg">verified</span>
</div>
...
<span className="text-xs font-semibold text-slate-600 dark:text-slate-400">(76 avis)</span>
</div>
<div className="flex gap-2">
<button className="flex-1 bg-primary text-white text-sm font-bold py-2 rounded-lg hover:bg-primary/90 transition-colors">Voir le profil</button>
<button className="px-3 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200 transition-colors">
...
<div>
<div className="flex items-center gap-1.5">
<h3 className="font-bold text-lg text-slate-900 dark:text-white">Nicolas Roux</h3>
<span className="material-symbols-outlined text-primary text-lg">verified</span>
</div>
...
<span className="text-xs font-semibold text-slate-600 dark:text-slate-400">(342 avis)</span>
</div>
<div className="flex gap-2">
<button className="flex-1 bg-primary text-white text-sm font-bold py-2 rounded-lg hover:bg-primary/90 transition-colors">Voir le profil</button>
<button className="px-3 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200 transition-colors">
...
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 disabled:opacity-50" disabled>
<span className="material-symbols-outlined">chevron_left</span>
</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg bg-primary text-white font-bold">1</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 border border-transparent">2</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 border border-transparent">3</button>
<span className="px-2">...</span>
<button className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 border border-transparent">8</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800">
...
<div>
<h4 className="font-bold text-slate-900 dark:text-white mb-4">Artisans</h4>
<ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
...
<div>
<h4 className="font-bold text-slate-900 dark:text-white mb-4">Aide</h4>
<ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
...
<a className="w-10 h-10 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 hover:bg-primary hover:text-white transition-all" href="#">
