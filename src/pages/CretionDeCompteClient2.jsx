...
<div>
<h3 className="font-bold text-slate-900">Avis vérifiés</h3>
<p className="text-sm text-slate-500">Consultez uniquement des avis de clients réels ayant effectué des travaux.</p>
</div>
</div>
<div className="flex gap-4 p-4 rounded-xl border border-slate-200 bg-white shadow-sm transition-all hover:shadow-md">
<div className="flex-shrink-0 flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10 text-primary">
...
<p className="text-sm text-slate-500">Vos transactions sont protégées par nos protocoles bancaires de pointe.</p>
</div>
</div>
<div className="flex gap-4 p-4 rounded-xl border border-slate-200 bg-white shadow-sm transition-all hover:shadow-md">
<div className="flex-shrink-0 flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10 text-primary">
...
<p className="text-sm text-slate-500">Gérez l'avancement de vos travaux et centralisez vos factures en un clic.</p>
</div>
</div>
</div>
...
<p className="text-white text-sm italic font-medium">"ArtisanDirect a simplifié ma rénovation de A à Z. La confiance est enfin au rendez-vous." âDAâ€ Marc L.</p>
</div>
</div>
</div>
...
<div className="mb-8">
<h2 className="text-2xl font-bold text-slate-900 mb-2">Créer un compte client</h2>
<p className="text-slate-500">Complétez le formulaire ci-dessous pour démarrer vos projets.</p>
</div>
...
<label className="text-sm font-semibold text-slate-700" htmlFor="first-name">Prénom</label>
...
<label className="text-sm font-semibold text-slate-700" htmlFor="address">Adresse détaillée</label>
...
<p className="text-xs font-bold text-blue-700 mb-2 uppercase tracking-wider">Règles de sécurité :</p>
...
<span className="text-sm text-slate-600 leading-tight">J'accepte les <a className="text-primary font-medium hover:underline" href="#">Conditions Générales d'Utilisation</a></span>
</label>
<label className="flex items-start gap-3 cursor-pointer">
<input className="mt-1 rounded border-slate-300 text-primary focus:ring-primary h-4 w-4" type="checkbox"/>
<span className="text-sm text-slate-600 leading-tight">Je consens au traitement de mes données conformément à la <a className="text-primary font-medium hover:underline" href="#">Politique de Confidentialité</a></span>
</label>
</div>
{/*  Submit Button  */}
