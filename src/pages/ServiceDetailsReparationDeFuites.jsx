...
<span className="material-symbols-outlined text-xs text-slate-400">chevron_right</span>
<span className="text-slate-900 font-medium">R̩paration de fuites</span>
</div>
...
<p className="text-slate-600">Pas de frais cach̩s, devis gratuit avant intervention.</p>
</div>
