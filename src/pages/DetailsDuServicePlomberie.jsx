...
<p className="text-slate-600 dark:text-slate-400">DÃ©crivez votre problÃ¨me en quelques clics via notre formulaire simple et rapide.</p>
</div>
<div className="flex flex-col items-center text-center p-8 rounded-xl border border-slate-200 dark:border-slate-800 bg-background-light dark:bg-background-dark hover:shadow-md transition-shadow">
<div className="size-16 rounded-full bg-primary/10 text-primary flex items-center justify-center mb-6">
...
<p className="text-slate-600 dark:text-slate-400">SÃ©lectionnez un expert local qualifiÃ© parmi nos professionnels vÃ©rifiÃ©s et certifiÃ©s.</p>
</div>
<div className="flex flex-col items-center text-center p-8 rounded-xl border border-slate-200 dark:border-slate-800 bg-background-light dark:bg-background-dark hover:shadow-md transition-shadow">
<div className="size-16 rounded-full bg-primary/10 text-primary flex items-center justify-center mb-6">
...
<p className="text-slate-600 dark:text-slate-400">Le plombier intervient rapidement et vous payez en toute sÃ©curitÃ© aprÃ¨s la prestation.</p>
</div>
</div>
</section>
{/*  Pricing Section  */}
...
<span className="text-primary font-bold">ÃDA partir de 45â‚¬</span>
</div>
...
<span className="text-white font-bold">ÃDA partir de 60â‚¬</span>
</div>
...
<span className="text-primary font-bold">ÃDA partir de 50â‚¬</span>
</div>
<ul className="space-y-3 mb-6 text-slate-600 dark:text-slate-400 text-sm">
...
<p className="mt-4 text-slate-600 dark:text-slate-400 text-sm leading-relaxed border-t border-slate-100 dark:border-slate-800 pt-4">
                            Le tarif affichÃ© correspond Ã  la main-d'Å“uvre et au dÃ©placement. Les piÃ¨ces de rechange nÃ©cessaires (joints, robinets, siphons) sont facturÃ©es en supplÃ©ment aprÃ¨s validation d'un devis gratuit sur place.
                        </p>
</details>
<details className="group bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-4">
<summary className="flex items-center justify-between cursor-pointer font-bold list-none">
