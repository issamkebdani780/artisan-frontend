...
<header className="sticky top-0 z-50 w-full border-b border-primary/10 bg-white/80 backdrop-blur-md px-6 py-3">
...
<h2 className="text-xl font-bold tracking-tight text-slate-900">Services Pro</h2>
</div>
...
<div className="hidden sm:flex items-center bg-slate-100 rounded-lg px-3 py-1.5 border border-transparent focus-within:border-primary/50 transition-all">
...
<p className="text-xs text-slate-600 mb-4">Nos experts sont disponibles pour vous conseiller.</p>
...
<h2 className="text-2xl font-black text-slate-900 tracking-tight">Notre Processus d'Excellence</h2>
...
<div className="absolute bottom-2 right-2 bg-white px-2 py-1 rounded-lg flex items-center gap-1 shadow-sm">
...
<div className="p-4">
<h4 className="font-bold text-slate-900">Thomas Bernard</h4>
...
<div className="p-4">
<h4 className="font-bold text-slate-900">Julie Petit</h4>
