...
<h2 className="text-slate-900 dark:text-slate-50 text-xl font-bold leading-tight tracking-[-0.015em]">ArtisanDirect</h2>
</div>
...
<a className="text-slate-700 dark:text-slate-300 text-sm font-medium hover:text-primary transition-colors" href="#">Paramètres</a>
</nav>
...
<input className="w-full rounded-lg border-slate-300 dark:border-slate-700 dark:bg-slate-800 focus:ring-primary focus:border-primary" type="text" value="Jean"/>
</div>
<div className="flex flex-col gap-2">
<label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Nom</label>
<input className="w-full rounded-lg border-slate-300 dark:border-slate-700 dark:bg-slate-800 focus:ring-primary focus:border-primary" type="text" value="Dupont"/>
</div>
</div>
<div className="flex flex-col gap-2">
...
<input className="w-full rounded-r-lg border-slate-300 dark:border-slate-700 dark:bg-slate-800 focus:ring-primary focus:border-primary" placeholder="06 12 34 56 78" type="tel"/>
</div>
</div>
</div>
</div>
...
<input className="w-full rounded-lg border-slate-300 dark:border-slate-700 dark:bg-slate-800 focus:ring-primary focus:border-primary" placeholder="15 Rue de la Paix" type="text"/>
</div>
<div className="flex flex-col gap-2">
<label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Ville</label>
<input className="w-full rounded-lg border-slate-300 dark:border-slate-700 dark:bg-slate-800 focus:ring-primary focus:border-primary" placeholder="Paris" type="text"/>
</div>
<div className="flex flex-col gap-2">
<label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Code Postal</label>
<input className="w-full rounded-lg border-slate-300 dark:border-slate-700 dark:bg-slate-800 focus:ring-primary focus:border-primary" placeholder="75002" type="text"/>
</div>
</div>
...
<input defaultChecked className="rounded text-primary focus:ring-primary size-5 border-slate-300 dark:border-slate-700 dark:bg-slate-800" type="checkbox"/>
...
<label className="flex items-center gap-3 cursor-pointer group">
<input className="rounded text-primary focus:ring-primary size-5 border-slate-300 dark:border-slate-700 dark:bg-slate-800" type="checkbox"/>
...
<button className="px-8 py-3 rounded-lg font-bold text-slate-600 dark:text-slate-400 border border-slate-300 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all" type="button">
                            Annuler
                        </button>
...
{/*  Toast Notification  */}
<div className="relative flex items-center gap-4 bg-white dark:bg-slate-800 border-l-4 border-green-500 px-6 py-4 rounded-xl shadow-2xl shadow-slate-200/50 dark:shadow-none animate-[bounce_1s_ease-in-out_1] pointer-events-auto">
...
<p className="text-slate-900 dark:text-slate-50 font-bold">Profil mis à jour</p>
<p className="text-slate-500 dark:text-slate-400 text-sm">Profil enregistré avec succès !</p>
</div>
<button className="ml-4 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors" onclick="this.parentElement.parentElement.remove()">
