...
<div className="text-3xl font-black text-primary mb-4">18 DA <span className="text-sm text-slate-400">/ mÂ²</span></div>
...
<div className="text-3xl font-black text-orange-500 mb-4">26 DA <span className="text-sm text-slate-400">/ mÂ²</span></div>
<ul className="text-xs space-y-2 text-slate-600">
...
<div className="text-3xl font-black text-red-500 mb-4">32 DA <span className="text-sm text-slate-400">/ mÂ²</span></div>
<ul className="text-xs space-y-2 text-slate-600">
