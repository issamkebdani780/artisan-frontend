...
<div>
<p className="font-bold text-slate-800">PrÃ©paration des supports</p>
...
<ul className="text-xs space-y-2 text-slate-600">
<li>â€¢ Impression isolante solvantÃ©e</li>
<li>â€¢ Neutralisation des odeurs</li>
<li>â€¢ Finition haute opacitÃ©</li>
</ul>
</div>
...
<button className="w-full py-2 bg-slate-100 text-slate-900 rounded-lg text-xs font-bold group-hover:bg-primary group-hover:text-white transition-all">RÃ©server Julien</button>
</div>
</div>
{/*  Painter 2  */}
<div className="group bg-white rounded-2xl p-6 shadow-sm border border-primary/5 hover:border-primary transition-all">
...
<button className="w-full py-2 bg-slate-100 text-slate-900 rounded-lg text-xs font-bold group-hover:bg-primary group-hover:text-white transition-all">RÃ©server Sarah</button>
</div>
</div>
{/*  Painter 3  */}
<div className="group bg-white rounded-2xl p-6 shadow-sm border border-primary/5 hover:border-primary transition-all">
...
<button className="w-full py-2 bg-slate-100 text-slate-900 rounded-lg text-xs font-bold group-hover:bg-primary group-hover:text-white transition-all">RÃ©server Marc</button>
</div>
</div>
{/*  Painter 4  */}
<div className="group bg-white rounded-2xl p-6 shadow-sm border border-primary/5 hover:border-primary transition-all">
...
<button className="w-full py-2 bg-slate-100 text-slate-900 rounded-lg text-xs font-bold group-hover:bg-primary group-hover:text-white transition-all">RÃ©server Karim</button>
</div>
</div>
</div>
</div>
