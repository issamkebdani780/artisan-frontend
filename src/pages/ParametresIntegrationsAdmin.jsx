...
<button className="px-6 py-4 text-sm font-bold border-b-2 border-primary text-primary">Int̩grations</button>
</div>
...
<p className="text-xs text-slate-500 mb-6">G̩olocalisation des prestations et calcul des itin̩raires.</p>
<div className="flex items-center justify-between pt-4 border-t border-slate-50">
