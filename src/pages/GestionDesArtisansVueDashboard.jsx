...
{/*  Header  */}
<header className="h-16 border-b border-slate-200 bg-white flex items-center justify-between px-8 shrink-0"><div className="flex items-center gap-3 pr-6 border-r border-slate-200 flex-col">
<div className="size-8 rounded-full bg-primary flex items-center justify-center text-white flex-col">
<span className="material-symbols-outlined text-lg">construction</span>
</div>
<div className="hidden sm:block">
<h1 className="text-slate-900 text-sm font-bold leading-tight">Annuaire Artisans</h1>
...
<span className="text-slate-900 text-sm font-medium">Annuaire des Artisans</span>
</div>
<div className="flex items-center gap-4 flex-col">
<div className="relative w-64">
<span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm">search</span>
<input className="w-full pl-10 pr-4 py-2 bg-slate-100 border-none rounded-xl text-sm focus:ring-2 focus:ring-purple-brand/50" placeholder="Rechercher un artisan..." type="text"/>
</div>
<button className="size-10 flex items-center justify-center rounded-xl bg-slate-100 text-slate-600 hover:bg-purple-brand hover:text-white transition-colors">
...
<td className="px-6 py-4 text-sm text-slate-600">12 Oct 2023</td>
<td className="px-6 py-4">
...
<div>
<p className="text-sm font-bold text-slate-900">Marie Lefebvre</p>
...
<div>
<p className="text-sm font-bold text-slate-900">Thomas Martin</p>
<p className="text-xs text-slate-500">thomas@bois-art.fr</p>
</div>
</div>
</td>
<td className="px-6 py-4">
<span className="px-2 py-1 bg-amber-100 text-amber-700 text-xs font-bold rounded-lg">Menuiserie</span>
</td>
<td className="px-6 py-4 text-sm text-slate-600">20 Oct 2023</td>
<td className="px-6 py-4">
<div className="flex items-center gap-1.5 text-emerald-600 flex-col">
<span className="material-symbols-outlined text-sm">verified</span>
<span className="text-xs font-bold">Vérifié</span>
...
<div>
<p className="text-sm font-bold text-slate-900">Sarah Bernard</p>
<p className="text-xs text-slate-500">sarah.peinture@gmail.com</p>
</div>
</div>
</td>
<td className="px-6 py-4">
<span className="px-2 py-1 bg-pink-100 text-pink-700 text-xs font-bold rounded-lg">Peinture</span>
</td>
<td className="px-6 py-4 text-sm text-slate-600">05 Nov 2023</td>
<td className="px-6 py-4">
...
<button className="size-8 flex items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 font-bold text-xs">2</button>
<button className="size-8 flex items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 font-bold text-xs">3</button>
<button className="size-8 flex items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-400 hover:text-purple-brand transition-colors">
