...
<a className="text-slate-600 dark:text-slate-300 text-sm font-medium hover:text-primary transition-colors" href="#">Réalisations</a>
...
<h2 className="text-2xl font-bold mb-6 text-slate-900 dark:text-slate-100">Nos experts à proximité</h2>
...
<h2 className="text-2xl font-bold mb-6 text-slate-900 dark:text-slate-100">Questions Fréquentes</h2>
