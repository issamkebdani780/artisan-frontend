...
<h2 className="text-slate-900 dark:text-slate-100 text-lg font-bold leading-tight tracking-tight">PlumbPro</h2>
</div>
...
<a className="text-slate-600 dark:text-slate-300 text-sm font-medium hover:text-primary transition-colors" href="#">RÃ©alisations</a>
...
<div className="bg-slate-200 dark:bg-slate-700 aspect-square rounded-full size-10 flex items-center justify-center overflow-hidden border border-slate-200 dark:border-slate-700">
...
<div>
<h3 className="text-slate-900 dark:text-slate-100 font-bold">Devis Gratuit</h3>
...
<a className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 text-sm transition-colors" href="#pricing">
<span className="material-symbols-outlined text-xl">payments</span> Tarifs
                            </a>
<a className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 text-sm transition-colors" href="#experts">
<span className="material-symbols-outlined text-xl">engineering</span> Experts
                            </a>
<a className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 text-sm transition-colors" href="#faq">
...
<span className="material-symbols-outlined text-sm">chevron_right</span>
<span className="text-slate-900 dark:text-slate-100 font-medium">Installation Robinetterie</span>
</nav>
...
<h2 className="text-2xl font-bold mb-6 text-slate-900 dark:text-slate-100">Nos solutions de robinetterie</h2>
...
<p className="text-primary font-bold">ÃDA partir de 89â‚¬</p>
</div>
<div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-primary transition-colors">
<div className="size-12 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center mb-4">
...
<p className="text-primary font-bold">ÃDA partir de 159â‚¬</p>
</div>
<div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-primary transition-colors">
<div className="size-12 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center mb-4">
...
<h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Grille Tarifaire Transparente</h2>
</div>
<table className="w-full text-left border-collapse">
<thead>
<tr className="bg-slate-50 dark:bg-slate-800/50">
<th className="p-4 text-sm font-bold text-slate-600 dark:text-slate-400">Prestation</th>
<th className="p-4 text-sm font-bold text-slate-600 dark:text-slate-400">Main d'Å“uvre</th>
<th className="p-4 text-sm font-bold text-slate-600 dark:text-slate-400">DurÃ©e estimÃ©e</th>
</tr>
</thead>
...
<div className="p-4 bg-slate-50 dark:bg-slate-800/50 flex items-center gap-2">
...
<h2 className="text-2xl font-bold mb-6 text-slate-900 dark:text-slate-100">Nos experts Ã  proximitÃ©</h2>
...
<p className="text-xs text-slate-500">Expert Robinetterie &amp; Sanitaire âDA¢ Disponible aujourd'hui</p>
<div className="flex items-center gap-2 mt-2">
<span className="text-[10px] bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded">RGE</span>
<span className="text-[10px] bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded">Garantie DÃ©cennale</span>
</div>
</div>
</div>
<div className="flex items-center gap-4 bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-800">
...
<p className="text-xs text-slate-500">SpÃ©cialiste installation cuisine âDA¢ Prochain RDV demain</p>
<div className="flex items-center gap-2 mt-2">
...
<h2 className="text-2xl font-bold mb-6 text-slate-900 dark:text-slate-100">Questions FrÃ©quentes</h2>
...
<div className="p-4 pt-0 text-sm text-slate-500 leading-relaxed border-t border-slate-50 dark:border-slate-800/50">
