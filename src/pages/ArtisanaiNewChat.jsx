...
<a className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg text-slate-600 hover:bg-slate-100" href="#">
...
<a className="flex items-center gap-3 px-3 py-2 text-xs font-medium rounded-lg text-slate-600 hover:bg-slate-100 truncate" href="#">
...
{/*  Main Content Area  */}
<main className="flex-1 flex flex-col bg-background-light overflow-y-auto">
{/*  Header  */}
<header className="flex items-center justify-between px-8 py-4 bg-white/80 backdrop-blur-md sticky top-0 z-10 border-b border-slate-200">
...
<button className="group flex flex-col text-left p-5 bg-white rounded-xl border border-slate-200 hover:border-primary transition-all shadow-sm hover:shadow-md">
...
<p className="text-xs text-slate-500 leading-relaxed">How do I verify my account and identity?</p>
</button>
<button className="group flex flex-col text-left p-5 bg-white rounded-xl border border-slate-200 hover:border-primary transition-all shadow-sm hover:shadow-md">
...
<p className="text-xs text-slate-500 leading-relaxed">What is the process to get a custom quote?</p>
</button>
<button className="group flex flex-col text-left p-5 bg-white rounded-xl border border-slate-200 hover:border-primary transition-all shadow-sm hover:shadow-md">
...
<p className="text-xs text-slate-500 leading-relaxed">Which payment methods do you support?</p>
</button>
</div>
{/*  Chat Input Area  */}
...
<input className="block w-full pl-12 pr-32 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-2 focus:ring-primary focus:border-transparent transition-all shadow-xl" placeholder="Type your question here..." type="text"/>
