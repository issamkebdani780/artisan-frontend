...
{/*  Navigation Bar  */}
<header className="sticky top-0 z-50 w-full border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md px-4 lg:px-40 py-3">
...
<button className="flex items-center justify-center rounded-lg h-10 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 px-3 transition-colors">
...
<h1 className="mt-4 text-2xl font-bold text-slate-900 dark:text-slate-100">Robert Miller</h1>
<p className="text-primary font-semibold text-sm">Master Carpenter âDA¢ 12 years exp.</p>
<div className="flex items-center gap-1 mt-2 text-yellow-500">
<span className="material-symbols-outlined fill-1">star</span>
<span className="font-bold text-slate-900 dark:text-slate-100">4.9</span>
<span className="text-slate-500 dark:text-slate-400 font-normal text-xs">(128 reviews)</span>
</div>
</div>
...
<p className="text-sm text-slate-500 dark:text-slate-400">Get a professional estimation for your project</p>
</div>
</div>
...
<select className="w-full bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 rounded-lg text-sm focus:ring-primary focus:border-primary">
...
<textarea className="w-full bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 rounded-lg text-sm focus:ring-primary focus:border-primary" placeholder="Tell Robert about your project..." rows="3"></textarea>
</div>
...
<p className="text-lg font-bold text-slate-700 dark:text-slate-300">3-5 Days</p>
</div>
</div>
...
<button className="w-full mt-4 py-3 border border-slate-200 dark:border-slate-800 rounded-lg text-sm font-bold text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                        Load More Reviews
                    </button>
</section>
</div>
...
{/*  Footer Area  */}
<footer className="mt-auto border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-background-dark py-10">
