...
<h2 className="text-slate-900 dark:text-white text-xl font-bold leading-tight tracking-[-0.015em]">CleanPro</h2>
</div>
<div className="flex flex-1 justify-end gap-4 items-center">
<nav className="hidden md:flex gap-6 mr-6 text-sm font-medium">
<a className="text-primary" href="#">Services</a>
<a className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors" href="#">Experts</a>
<a className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors" href="#">Tarifs</a>
</nav>
<div className="flex gap-2">
<button className="flex items-center justify-center rounded-lg h-10 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-100 px-3 hover:bg-slate-200 transition-colors">
...
{/*  Pricing Card  */}
<div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-primary/10 shadow-sm flex flex-wrap items-center justify-between gap-4">
<div className="flex items-center gap-4">
<div className="size-12 rounded-full bg-primary/10 flex items-center justify-center text-primary">
<span className="material-symbols-outlined text-3xl">payments</span>
</div>
<div>
<p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Tarif transparent</p>
<p className="text-slate-900 dark:text-white text-3xl font-bold">45€ <span className="text-lg font-normal text-slate-500">/ heure</span></p>
</div>
</div>
...
<div className="flex gap-4 p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-100 dark:border-slate-800">
<span className="material-symbols-outlined text-primary">kitchen</span>
<div>
<h3 className="font-bold text-slate-900 dark:text-white">Électroménagers</h3>
<p className="text-sm text-slate-600 dark:text-slate-400">Nettoyage intérieur du four, du micro-ondes et du réfrigérateur.</p>
</div>
</div>
<div className="flex gap-4 p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-100 dark:border-slate-800">
<span className="material-symbols-outlined text-primary">inventory_2</span>
<div>
<h3 className="font-bold text-slate-900 dark:text-white">Placards &amp; Tiroirs</h3>
<p className="text-sm text-slate-600 dark:text-slate-400">Nettoyage minutieux de l'intérieur et extérieur des rangements.</p>
</div>
</div>
<div className="flex gap-4 p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-100 dark:border-slate-800">
<span className="material-symbols-outlined text-primary">mop</span>
<div>
<h3 className="font-bold text-slate-900 dark:text-white">Récurage Intensif</h3>
<p className="text-sm text-slate-600 dark:text-slate-400">Détartrage profond des joints, robinetteries et parois de douche.</p>
</div>
</div>
<div className="flex gap-4 p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-100 dark:border-slate-800">
<span className="material-symbols-outlined text-primary">window</span>
<div>
<h3 className="font-bold text-slate-900 dark:text-white">Fenêtres &amp; Rails</h3>
<p className="text-sm text-slate-600 dark:text-slate-400">Lavage des vitres intérieures, encadrements et rails coulissants.</p>
</div>
</div>
<div className="flex gap-4 p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-100 dark:border-slate-800">
<span className="material-symbols-outlined text-primary">detector_status</span>
<div>
<h3 className="font-bold text-slate-900 dark:text-white">Points de contact</h3>
<p className="text-sm text-slate-600 dark:text-slate-400">Désinfection des poignées, interrupteurs et plinthes.</p>
</div>
</div>
<div className="flex gap-4 p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-100 dark:border-slate-800">
<span className="material-symbols-outlined text-primary">layers</span>
<div>
<h3 className="font-bold text-slate-900 dark:text-white">Zones difficiles</h3>
<p className="text-sm text-slate-600 dark:text-slate-400">Nettoyage derrière les meubles lourds et sous les appareils.</p>
</div>
</div>
</div>
</section>
...
<h2 className="text-xl font-bold mb-6 text-slate-900 dark:text-white">Experts disponibles</h2>
...
<h4 className="font-bold text-slate-900 dark:text-white leading-none">Sophie Martin</h4>
...
<p className="text-xs text-slate-500 dark:text-slate-400 mt-1">128 interventions</p>
...
<div className="flex-1">
<div className="flex justify-between items-start">
<h4 className="font-bold text-slate-900 dark:text-white leading-none">Marc Durand</h4>
<span className="flex items-center text-amber-500 text-sm font-bold">
<span className="material-symbols-outlined text-xs">star</span> 4.8
                                        </span>
</div>
<p className="text-xs text-slate-500 dark:text-slate-400 mt-1">94 interventions</p>
<div className="flex gap-1 mt-1">
...
<div className="flex-1">
<div className="flex justify-between items-start">
<h4 className="font-bold text-slate-900 dark:text-white leading-none">Léa Roux</h4>
<span className="flex items-center text-amber-500 text-sm font-bold">
<span className="material-symbols-outlined text-xs">star</span> 5.0
                                        </span>
</div>
<p className="text-xs text-slate-500 dark:text-slate-400 mt-1">215 interventions</p>
<div className="flex gap-1 mt-1">
...
<span>Assurance dommages incluse jusqu'à 2M€</span>
</li>
<li className="flex items-start gap-2 text-sm text-slate-700 dark:text-slate-300">
...
<h2 className="text-slate-900 dark:text-white text-2xl font-bold mb-6">Zone d'intervention</h2>
<div className="w-full h-64 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-inner">
<div className="w-full h-full bg-slate-200 dark:bg-slate-800 relative flex items-center justify-center">
...
<div className="absolute bg-white dark:bg-slate-900 px-4 py-2 rounded-lg shadow-lg border border-primary flex items-center gap-2">
