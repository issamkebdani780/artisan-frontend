...
<p className="text-slate-200 text-lg max-w-2xl">Une remise Ã  neuf complÃ¨te et mÃ©ticuleuse de votre domicile par nos experts certifiÃ©s.</p>
</div>
</div>
</div>
...
<span className="material-symbols-outlined text-primary">checklist</span>
                            TÃ¢ches incluses dans le nettoyage profond
                        </h2>
...
<div>
<h3 className="font-bold text-slate-900">Ã‰lectromÃ©nagers</h3>
<p className="text-sm text-slate-600">Nettoyage intÃ©rieur du four, du micro-ondes et du rÃ©frigÃ©rateur.</p>
</div>
</div>
<div className="flex gap-4 p-4 bg-white rounded-lg border border-slate-100">
...
<p className="text-sm text-slate-600">Nettoyage minutieux de l'intÃ©rieur et extÃ©rieur des rangements.</p>
</div>
</div>
<div className="flex gap-4 p-4 bg-white rounded-lg border border-slate-100">
<span className="material-symbols-outlined text-primary">mop</span>
<div>
<h3 className="font-bold text-slate-900">RÃ©curage Intensif</h3>
<p className="text-sm text-slate-600">DÃ©tartrage profond des joints, robinetteries et parois de douche.</p>
</div>
</div>
<div className="flex gap-4 p-4 bg-white rounded-lg border border-slate-100">
...
<p className="text-sm text-slate-600">Lavage des vitres intÃ©rieures, encadrements et rails coulissants.</p>
</div>
</div>
<div className="flex gap-4 p-4 bg-white rounded-lg border border-slate-100">
...
<p className="text-sm text-slate-600">DÃ©sinfection des poignÃ©es, interrupteurs et plinthes.</p>
</div>
</div>
<div className="flex gap-4 p-4 bg-white rounded-lg border border-slate-100">
...
<p className="text-sm text-slate-600">Nettoyage derriÃ¨re les meubles lourds et sous les appareils.</p>
</div>
</div>
</div>
</section>
...
<span className="px-2 py-0.5 bg-primary/10 text-primary text-[10px] font-bold rounded uppercase">CertifiÃ©e</span>
</div>
</div>
</div>
{/*  Expert 2  */}
...
<span>Assurance dommages incluse jusqu'Ã  2Mâ‚¬</span>
</li>
<li className="flex items-start gap-2 text-sm text-slate-700">
<span className="material-symbols-outlined text-primary text-lg leading-none">eco</span>
<span>Produits Ã©co-responsables sur demande</span>
</li>
<li className="flex items-start gap-2 text-sm text-slate-700">
...
<span className="font-bold text-sm">Disponible Ã  Paris et ÃŽle-de-France</span>
</div>
</div>
</div>
</section>
...
<p className="max-w-sm mb-6">Le leader du nettoyage professionnel Ã  domicile. Nous transformons votre espace de vie avec excellence et rigueur.</p>
</div>
<div>
...
<li><a className="hover:text-primary transition-colors" href="#">Blog PropretÃ©</a></li>
</ul>
</div>
<div>
<h4 className="text-white font-bold mb-4 uppercase text-xs tracking-widest">LÃ©gal</h4>
<ul className="space-y-2 text-sm">
...
<div className="max-w-[1200px] mx-auto mt-12 pt-8 border-t border-slate-800 text-center text-xs">
                Â© 2024 CleanPro SAS. Tous droits rÃ©servÃ©s.
            </div>
</footer>
</div>
</div>
