...
{/*  Sidebar (Using layout from SCREEN_256)  */}
...
<span className="text-sm font-medium">V√©rifications</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-purple-900 transition-colors" href="#">
...
<input className="w-full pl-10 pr-4 py-2 bg-slate-100 dark:bg-slate-800 border-none rounded-xl text-sm focus:ring-2 focus:ring-purple-500" placeholder="Rechercher des param√®tres..." type="text"/>
</div>
<div className="flex items-center gap-2">
...
{/*  Title Section  */}
<div className="mb-8">
<h1 className="text-3xl font-black tracking-tight text-slate-900 dark:text-white">Param√®tres Syst√®me</h1>
<p className="text-slate-500 dark:text-slate-400 mt-2">G√©rez la configuration globale de The Violet Protocol et ajustez les pr√©f√©rences syst√®me de votre environnement.</p>
</div>
{/*  Tabbed Navigation  */}
<div className="flex border-b border-slate-200 dark:border-slate-800 mb-8">
<button className="px-6 py-4 text-sm font-medium text-slate-500 hover:text-purple-600 transition-colors">G√©n√©ral</button>
<button className="px-6 py-4 text-sm font-bold border-b-2 border-primary text-primary">S√©curit√©</button>
...
<button className="px-6 py-4 text-sm font-medium text-slate-500 hover:text-purple-600 transition-colors">Int√©grations</button>
</div>
...
<input className="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-xl p-3 text-sm focus:ring-2 focus:ring-purple-500 transition-all outline-none" id="current-password" placeholder="‚DA¢‚DA¢‚DA¢‚DA¢‚DA¢‚DA¢‚DA¢‚DA¢‚DA¢‚DA¢‚DA¢‚DA¢" type="password"/>
</div>
</div>
<div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
...
<p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Ajoutez une couche de s√©curit√© suppl√©mentaire √† votre compte.</p>
</div>
</div>
...
<p className="text-xs text-slate-500">Paris, France ‚DA¢ En ce moment m√™me</p>
</div>
</div>
...
<p className="text-xs text-slate-500">Lyon, France ‚DA¢ Il y a 2 heures</p>
</div>
</div>
<button className="text-xs font-bold text-red-500 hover:text-red-600 transition-colors">D√©connecter</button>
</div>
</div>
</section>
{/*  Primary Action  */}
...
<h3 className="font-bold text-slate-900 dark:text-white">Informations Syst√®me</h3>
...
<div className="flex items-center gap-3">
<div className="h-2 w-2 rounded-full bg-green-500"></div>
<span className="text-sm font-medium">Base de donn√©es : Optimis√©e</span>
</div>
<div className="flex items-center gap-3">
...
{/*  AI Insight Component (Reused from existing for visual richness)  */}
...
<p className="text-sm italic leading-relaxed text-purple-50">
                                "L'activation du mode maintenance est recommand√©e le dimanche √† 03:00 GMT pour minimiser l'impact sur les curations actives."
                            </p>
</div>
...
<p>¬© 2023 Admin Panel Purple Edition. Tous droits r√©serv√©s.</p>
<div className="mt-2 flex justify-center gap-4">
<a className="hover:text-purple-500 transition-colors" href="#">Aide</a>
<a className="hover:text-purple-500 transition-colors" href="#">Confidentialit√©</a>
...
export default ParametresSecuriteAdmin;
