...
<header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 dark:border-slate-800 bg-white dark:bg-background-dark px-6 md:px-20 py-3 sticky top-0 z-50">
<div className="flex items-center gap-8">
<div className="flex items-center gap-4 text-primary">
<div className="size-6">
<span className="material-symbols-outlined text-3xl">local_shipping</span>
</div>
<h2 className="text-slate-900 dark:text-slate-100 text-lg font-bold leading-tight tracking-[-0.015em]">Déménagement Pro</h2>
</div>
<div className="hidden md:flex items-center gap-6">
<a className="text-slate-600 dark:text-slate-400 text-sm font-medium hover:text-primary transition-colors" href="#">FR</a>
<a className="text-slate-600 dark:text-slate-400 text-sm font-medium hover:text-primary transition-colors" href="#">AR</a>
<a className="text-slate-600 dark:text-slate-400 text-sm font-medium hover:text-primary transition-colors" href="#">EN</a>
</div>
</div>
...
<h2 className="text-slate-900 dark:text-slate-100 text-3xl font-bold leading-tight mb-8">Comment ça marche</h2>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
<div className="flex flex-col gap-4 p-6 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm">
<div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center text-primary">
<span className="material-symbols-outlined text-2xl">calendar_month</span>
</div>
<h3 className="text-xl font-bold">1. Réservation en ligne</h3>
<p className="text-slate-600 dark:text-slate-400">Choisissez votre formule et votre date en quelques clics. Recevez une confirmation immédiate.</p>
</div>
<div className="flex flex-col gap-4 p-6 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm">
<div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center text-primary">
...
<p className="text-slate-600 dark:text-slate-400">Nos experts protègent vos biens avec du matériel professionnel et chargent le camion avec soin.</p>
</div>
<div className="flex flex-col gap-4 p-6 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm">
<div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center text-primary">
...
<p className="text-slate-600 dark:text-slate-400">Transport sécurisé et déchargement. Nous plaçons vos meubles exactement là où vous le souhaitez.</p>
</div>
</div>
</section>
<section className="px-4 md:px-20 py-12 bg-slate-50 dark:bg-slate-900/50">
<div className="flex flex-col items-center text-center mb-12">
<h2 className="text-slate-900 dark:text-slate-100 text-3xl font-bold leading-tight">Tarification et Détails</h2>
<p className="text-slate-600 dark:text-slate-400 mt-2">Des tarifs transparents adaptés à tous vos besoins de mobilité.</p>
</div>
<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
<div className="flex flex-col p-8 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
...
<div className="flex flex-col p-8 rounded-xl bg-white dark:bg-slate-900 border-2 border-primary relative shadow-xl transform scale-105">
...
<section className="px-4 md:px-20 py-12">
<h2 className="text-slate-900 dark:text-slate-100 text-3xl font-bold mb-8">Nos meilleurs déménageurs</h2>
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
<div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 flex flex-col items-center text-center">
...
<p className="text-sm text-slate-600 dark:text-slate-400 italic">"12 ans d'expérience. Spécialiste des objets fragiles et du montage de meubles complexes."</p>
</div>
<div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 flex flex-col items-center text-center">
<div className="size-24 rounded-full overflow-hidden mb-4 border-4 border-primary/20">
...
<p className="text-sm text-slate-600 dark:text-slate-400 italic">"Experte en logistique et organisation. Je m'assure que chaque carton arrive au bon endroit."</p>
</div>
<div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 flex flex-col items-center text-center">
<div className="size-24 rounded-full overflow-hidden mb-4 border-4 border-primary/20">
...
<p className="text-sm text-slate-600 dark:text-slate-400 italic">"Expert en transport d'objets lourds. Maniaque de la protection et de la sécurité du matériel."</p>
</div>
</div>
</section>
<section className="px-4 md:px-20 py-16 bg-slate-50 dark:bg-slate-900/30">
<h2 className="text-slate-900 dark:text-slate-100 text-3xl font-bold mb-8 text-center">Questions fréquentes</h2>
...
<p className="text-slate-600 dark:text-slate-400">Oui, selon la formule choisie, nous pouvons vous fournir tout le matériel nécessaire (cartons, ruban adhésif, papier bulle) ou même nous occuper de l'emballage complet.</p>
</div>
<div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-6">
<h4 className="font-bold mb-2 flex justify-between items-center">
...
<p className="text-slate-600 dark:text-slate-400">Absolument. Tous nos déménagements incluent une assurance responsabilité civile professionnelle. Pour les objets de grande valeur, nous proposons des extensions d'assurance ad valorem.</p>
</div>
<div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-6">
<h4 className="font-bold mb-2 flex justify-between items-center">
...
<p className="text-slate-600 dark:text-slate-400">Nous recommandons de réserver au moins 2 à 3 semaines à l'avance, surtout pour les déménagements en fin de mois ou pendant le week-end, qui sont des périodes très demandées.</p>
</div>
</div>
</section>
</main>
...
<span className="font-bold text-xl text-slate-900 dark:text-slate-100">Déménagement Pro</span>
</div>
...
<p className="text-sm text-slate-600 dark:text-slate-400 mb-4">Recevez nos conseils pour un déménagement réussi.</p>
<div className="flex gap-2">
<input className="form-input flex-1 rounded-lg border-slate-300 dark:border-slate-700 dark:bg-slate-800 text-sm focus:border-primary focus:ring-primary" placeholder="Email" type="email"/>
<button className="bg-primary text-white px-4 py-2 rounded-lg text-sm font-bold">OK</button>
</div>
</div>
</div>
<div className="mt-12 pt-8 border-t border-slate-100 dark:border-slate-800 text-center text-xs text-slate-500">
