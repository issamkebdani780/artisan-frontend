...
<div className="flex items-center gap-4">
<img alt="Jean Dupont" className="w-20 h-20 rounded-full object-cover border-4 border-white shadow-sm" data-alt="Portrait d'un expert d̩m̩nageur souriant" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBVErJYB1JoAVZ6LzlUHZqnsEm3gQodvM_7c2ehaEdcw4V-b19reUUoEpmjsqzAdZak-bbnhuMQe6ly29UuHDxorDRUcJMKbnlNsbkkuuHqKlCDPlGNzVmH5MX8S_t-scuFZ2wZZYMfbLx18SX0PmT3v01AEK_HfaIjT9ZK8SX1iqUcNrRxjx3zcuG8Uv9lbqe1V_x_nBJkCcImcObZMjXAjp54rAQ8P0-mD0ROhireuIFyPgT6Z9KtRed81FMjNtuAfF7V_WdGXXYp"/>
<div>
