...
<h2 className="text-slate-900 text-xl font-bold leading-tight tracking-tight">M̩nagePro</h2>
</div>
...
<div className="text-slate-500 flex border-none bg-slate-100 items-center justify-center pl-4">
<span className="material-symbols-outlined text-xl">search</span>
</div>
<input className="form-input flex w-full min-w-0 flex-1 border-none bg-slate-100 text-slate-900 focus:ring-0 h-full placeholder:text-slate-500 text-sm font-normal px-4" placeholder="Trouver un service..."/>
</div>
</label>
...
<h2 className="text-slate-900 text-3xl font-bold mb-10 text-center">Comment ̤a marche</h2>
...
<p className="text-slate-600">Choisissez une date, l'heure et la fr̩quence qui vous conviennent le mieux.</p>
</div>
<div className="flex flex-col items-center text-center p-6 bg-white rounded-xl shadow-sm border border-slate-100">
<div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center text-primary mb-6">
...
<p className="text-slate-600">Notre agent rigoureusement s̩lectionn̩ arrive avec tout le mat̩riel n̩cessaire.</p>
</div>
<div className="flex flex-col items-center text-center p-6 bg-white rounded-xl shadow-sm border border-slate-100">
<div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center text-primary mb-6">
...
<p className="text-slate-600">D̩tendez-vous et retrouvez un foyer parfaitement propre et sain.</p>
</div>
</div>
</section>
{/*  Pricing Section  */}
<section className="mb-20">
<h2 className="text-slate-900 text-3xl font-bold mb-10">Tarification et D̩tails</h2>
<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
{/*  Card 1  */}
<div className="bg-white rounded-xl overflow-hidden border border-slate-200 flex flex-col h-full">
<div className="p-6 border-b border-slate-100">
<h3 className="text-xl font-bold text-slate-900">M̩nage R̩gulier</h3>
...
<button className="w-full py-3 bg-white border text-primary font-bold rounded-lg hover:bg-primary hover:text-white transition-all border-[#1abc9c] text-[#1abc9c] border-[#1abc9c]">Choisir ce forfait</button>
</div>
</div>
{/*  Card 2  */}
<div className="bg-white rounded-xl overflow-hidden border-2 relative flex flex-col h-full shadow-xl scale-105 z-10 border-[#1abc9c]">
...
<div className="p-6 bg-slate-50">
<button className="w-full py-3 bg-white border text-primary font-bold rounded-lg hover:bg-primary hover:text-white transition-all border-[#1abc9c] text-[#1abc9c] border-[#1abc9c]">Demander un devis</button>
</div>
</div>
</div>
</section>
...
<div>
<h2 className="text-slate-900 text-3xl font-bold">Nos meilleurs agents</h2>
...
<h4 className="text-lg font-bold text-slate-900">Sarah L.</h4>
...
<span className="material-symbols-outlined text-lg fill-1">star</span>
<span className="material-symbols-outlined text-lg fill-1">star</span>
<span className="text-slate-600 text-xs font-bold ml-1">(124 avis)</span>
</div>
...
<h4 className="text-lg font-bold text-slate-900">Marc D.</h4>
<div className="flex items-center justify-center gap-1 text-yellow-400 my-2">
<span className="material-symbols-outlined text-lg fill-1">star</span>
<span className="material-symbols-outlined text-lg fill-1">star</span>
<span className="material-symbols-outlined text-lg fill-1">star</span>
<span className="material-symbols-outlined text-lg fill-1">star</span>
<span className="material-symbols-outlined text-lg fill-1">star</span>
<span className="text-slate-600 text-xs font-bold ml-1">(89 avis)</span>
</div>
<p className="text-slate-500 text-sm mb-6 leading-relaxed">
...
<h4 className="text-lg font-bold text-slate-900">In̬s K.</h4>
<div className="flex items-center justify-center gap-1 text-yellow-400 my-2">
<span className="material-symbols-outlined text-lg fill-1">star</span>
<span className="material-symbols-outlined text-lg fill-1">star</span>
<span className="material-symbols-outlined text-lg fill-1">star</span>
<span className="material-symbols-outlined text-lg fill-1">star</span>
<span className="material-symbols-outlined text-lg fill-1">star</span>
<span className="text-slate-600 text-xs font-bold ml-1">(210 avis)</span>
</div>
<p className="text-slate-500 text-sm mb-6 leading-relaxed">
...
{/*  FAQ Section  */}
<section className="mb-20">
<h2 className="text-slate-900 text-3xl font-bold mb-10 text-center">Questions fr̩quentes</h2>
