...
<h2 className="text-slate-900 dark:text-slate-100 text-lg font-bold leading-tight tracking-[-0.015em]">Déménagement</h2>
</div>
<div className="hidden md:flex items-center gap-9">
<a className="text-slate-600 dark:text-slate-400 text-sm font-medium hover:text-primary transition-colors" href="#">Services</a>
<a className="text-slate-600 dark:text-slate-400 text-sm font-medium hover:text-primary transition-colors" href="#">Experts</a>
<a className="text-slate-600 dark:text-slate-400 text-sm font-medium hover:text-primary transition-colors" href="#">Tarifs</a>
...
<h1 className="text-slate-900 dark:text-slate-100 text-base font-bold leading-tight">Expert Moving</h1>
<p className="text-slate-500 dark:text-slate-400 text-xs font-normal">Service certifié</p>
</div>
</div>
...
<a className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors mt-8" href="#">
...
<section>
<h2 className="text-slate-900 dark:text-slate-100 text-2xl font-bold mb-6 flex items-center gap-2">
<span className="material-symbols-outlined text-primary">category</span> Nos options de service
                        </h2>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
<div className="group bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 hover:shadow-xl transition-all hover:-translate-y-1">
...
<p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">Service rapide et efficace au sein de votre ville actuelle avec une équipe dédiée.</p>
</div>
<div className="group bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 hover:shadow-xl transition-all hover:-translate-y-1">
<div className="size-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary group-hover:text-white transition-colors">
...
<p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">Transports sécurisés vers n'importe quelle destination dans le pays avec suivi en temps réel.</p>
</div>
<div className="group bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 hover:shadow-xl transition-all hover:-translate-y-1">
<div className="size-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary group-hover:text-white transition-colors">
...
<p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">Protection maximale de vos objets fragiles avec du matériel professionnel.</p>
</div>
</div>
</section>
<section className="bg-slate-100 dark:bg-slate-900/50 rounded-2xl p-8 md:p-12">
<div className="text-center mb-10">
<h2 className="text-2xl md:text-3xl font-bold mb-4">Pourquoi nous choisir ?</h2>
<p className="text-slate-500 dark:text-slate-400">L'excellence au service de votre mobilité</p>
</div>
...
<p className="text-slate-500 dark:text-slate-400 text-sm">Chaque membre de notre équipe est formé aux techniques de manutention les plus récentes.</p>
</div>
</div>
<div className="flex gap-4">
<div className="shrink-0 size-10 rounded-full bg-primary flex items-center justify-center text-white">
...
<p className="text-slate-500 dark:text-slate-400 text-sm">Nous nous adaptons à votre calendrier, même pour les demandes de dernière minute.</p>
</div>
</div>
<div className="flex gap-4">
<div className="shrink-0 size-10 rounded-full bg-primary flex items-center justify-center text-white">
...
<p className="text-slate-500 dark:text-slate-400 text-sm">Vos biens sont couverts à 100% de la prise en charge jusqu'à la livraison finale.</p>
</div>
</div>
<div className="flex gap-4">
<div className="shrink-0 size-10 rounded-full bg-primary flex items-center justify-center text-white">
...
<p className="text-slate-500 dark:text-slate-400 text-sm">Pas de frais cachés. Le prix annoncé sur votre devis est le prix final payé.</p>
</div>
</div>
</div>
</section>
<section>
<h2 className="text-slate-900 dark:text-slate-100 text-2xl font-bold mb-6">Estimations de prix</h2>
...
<td className="p-4 text-sm text-slate-500">10-15 m³</td>
<td className="p-4 text-sm font-bold text-primary text-right">350 €</td>
</tr>
<tr>
<td className="p-4 text-sm">Appartement T2/T3</td>
<td className="p-4 text-sm text-slate-500">20-30 m³</td>
<td className="p-4 text-sm font-bold text-primary text-right">650 €</td>
</tr>
<tr>
<td className="p-4 text-sm">Maison familiale</td>
<td className="p-4 text-sm text-slate-500">45+ m³</td>
<td className="p-4 text-sm font-bold text-primary text-right">1 200 €</td>
</tr>
</tbody>
</table>
</div>
...
<h2 className="text-slate-900 dark:text-slate-100 text-2xl font-bold">Experts à proximité</h2>
...
<h2 className="text-slate-900 dark:text-slate-100 text-2xl font-bold mb-6">Foire Aux Questions</h2>
<div className="space-y-4">
<details className="group bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 cursor-pointer">
...
<p className="mt-4 text-slate-500 dark:text-slate-400 text-sm">Nous recommandons de réserver au moins 2 à 4 semaines à l'avance, surtout pour les déménagements en fin de semaine ou en période estivale.</p>
</details>
<details className="group bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 cursor-pointer">
<summary className="flex items-center justify-between font-bold list-none">
...
<p className="mt-4 text-slate-500 dark:text-slate-400 text-sm">Oui, nous proposons des kits complets de cartons et matériel de protection (papier bulle, adhésifs) adaptés à la taille de votre logement.</p>
</details>
<details className="group bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 cursor-pointer">
<summary className="flex items-center justify-between font-bold list-none">
...
<p className="mt-4 text-slate-500 dark:text-slate-400 text-sm">Tous nos services incluent une assurance responsabilité civile. En cas de dommage constaté, notre assurance prend en charge le remboursement ou la réparation de l'objet.</p>
</details>
</div>
</section>
</div>
