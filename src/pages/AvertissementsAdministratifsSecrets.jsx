...
<p className="text-slate-600 text-lg">Suivi officiel de la conformitÃ© et de la qualitÃ© de vos services sur la plateforme.</p>
</div>
...
<h3 className="text-lg font-bold text-slate-900 mb-1">Politique de ConfidentialitÃ© &amp; NeutralitÃ©</h3>
...
<span className="text-slate-400 text-xs">â€¢ Mis Ã  jour le 12 Mai 2024</span>
</div>
<h3 className="text-xl font-bold text-slate-900">QualitÃ© de service &amp; Finitions</h3>
</div>
...
<span className="text-slate-400 text-xs">â€¢ ClassÃ© le 15 Mars 2024</span>
</div>
<h3 className="text-xl font-bold text-slate-900">DÃ©lai de rÃ©ponse (Communication)</h3>
</div>
<span className="bg-emerald-100 text-emerald-700 text-xs font-bold px-3 py-1 rounded-full">Dossier clÃ´turÃ©</span>
</div>
<p className="text-slate-600 text-sm leading-relaxed mb-6 italic">
