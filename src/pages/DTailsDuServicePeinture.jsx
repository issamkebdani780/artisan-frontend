...
<h3 className="text-slate-900 dark:text-slate-100 text-xl font-bold">1. Réservez</h3>
<p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Choisissez votre type de projet, la surface à peindre et votre date idéale en quelques clics.</p>
</div>
</div>
<div className="flex flex-col gap-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-8 hover:shadow-md transition-shadow">
<div className="text-primary bg-primary/10 w-12 h-12 rounded-lg flex items-center justify-center">
...
<p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Sélectionnez un peintre qualifié parmi nos experts certifiés en consultant leurs avis et réalisations.</p>
</div>
</div>
<div className="flex flex-col gap-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-8 hover:shadow-md transition-shadow">
<div className="text-primary bg-primary/10 w-12 h-12 rounded-lg flex items-center justify-center">
...
<p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Le peintre arrive à l'heure prévue, protège votre mobilier et réalise vos travaux avec soin.</p>
</div>
</div>
</div>
</section>
...
<p className="text-slate-600 dark:text-slate-400 mt-2">Prix estimés par m² incluant la main d'œuvre et le matériel de base.</p>
</div>
...
<p className="text-slate-600 dark:text-slate-400 text-sm mb-4">Préparation des supports et pose soignée de papier peint ou intissé.</p>
<div className="flex items-baseline gap-1 border-t border-slate-100 dark:border-slate-800 pt-4">
<span className="text-sm text-slate-500">à partir de</span>
...
{/*  FAQ Section  */}
<section className="mb-16">
<h2 className="text-slate-900 dark:text-slate-100 text-3xl font-bold leading-tight mb-8">Questions fréquentes</h2>
