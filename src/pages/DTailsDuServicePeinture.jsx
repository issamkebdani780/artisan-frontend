...
{/*  Top Navigation Bar  */}
<header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 dark:border-slate-800 px-6 md:px-20 py-3 bg-white dark:bg-background-dark sticky top-0 z-50">
...
<p className="text-white/90 text-base md:text-lg font-normal leading-relaxed">
                                Travaux de peinture intÃ©rieure, extÃ©rieure et pose de papier peint par des experts certifiÃ©s pour tous vos projets de rÃ©novation et dÃ©coration.
                            </p>
</div>
...
<h2 className="text-slate-900 dark:text-slate-100 text-3xl font-bold leading-tight mb-8">Comment Ã§a marche</h2>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
<div className="flex flex-col gap-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-8 hover:shadow-md transition-shadow">
<div className="text-primary bg-primary/10 w-12 h-12 rounded-lg flex items-center justify-center">
<span className="material-symbols-outlined text-3xl">calendar_month</span>
</div>
<div className="flex flex-col gap-2">
<h3 className="text-slate-900 dark:text-slate-100 text-xl font-bold">1. RÃ©servez</h3>
<p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Choisissez votre type de projet, la surface Ã  peindre et votre date idÃ©ale en quelques clics.</p>
</div>
</div>
<div className="flex flex-col gap-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-8 hover:shadow-md transition-shadow">
<div className="text-primary bg-primary/10 w-12 h-12 rounded-lg flex items-center justify-center">
...
<div className="flex flex-col gap-2">
<h3 className="text-slate-900 dark:text-slate-100 text-xl font-bold">2. Choisissez</h3>
<p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">SÃ©lectionnez un peintre qualifiÃ© parmi nos experts certifiÃ©s en consultant leurs avis et rÃ©alisations.</p>
</div>
</div>
<div className="flex flex-col gap-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-8 hover:shadow-md transition-shadow">
<div className="text-primary bg-primary/10 w-12 h-12 rounded-lg flex items-center justify-center">
...
<div className="flex flex-col gap-2">
<h3 className="text-slate-900 dark:text-slate-100 text-xl font-bold">3. C'est peint</h3>
<p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Le peintre arrive Ã  l'heure prÃ©vue, protÃ¨ge votre mobilier et rÃ©alise vos travaux avec soin.</p>
</div>
</div>
</div>
</section>
...
<p className="text-slate-600 dark:text-slate-400 mt-2">Prix estimÃ©s par mÂ² incluant la main d'Å“uvre et le matÃ©riel de base.</p>
</div>
<a className="text-primary font-bold hover:underline hidden md:block" href="#">Voir tout le catalogue</a>
</div>
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
{/*  Card 1  */}
<div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
<div className="h-48 bg-cover bg-center" data-alt="IntÃ©rieur d'un salon fraÃ®chement peint en bleu clair" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuAgxlppfyTjEytKDYfbWrShK7YmEiMeTTQ6X0BX-SuB8RC0dM6-AjYiqEEaKpmMBYW0KpcTaTNOKNJyHVfU50m_-JUkga1oj1qw2rlY7c3b62A0L1xv8B3Q4bpGQ_-9KFL-D4M9xDS6bHFRK-UQi8OszLBeupi_-rK7q44AMo0f8CbEptJJmu5fwm4p1aOqa-cphaaTUKVj9X95p5QQVPblSIsr2tjRqvBzCXYnM0c4dwQf3QG8_vRGFH715-5cmfHAoJRErG4hHTH9");'></div>
<div className="p-6">
<div className="flex items-center gap-2 mb-3">
<span className="material-symbols-outlined text-primary">wall_art</span>
<span className="text-xs font-bold uppercase tracking-wider text-slate-500">Murs IntÃ©rieurs</span>
</div>
<h3 className="text-xl font-bold mb-2">Peinture IntÃ©rieure (mÂ²)</h3>
<p className="text-slate-600 dark:text-slate-400 text-sm mb-4">Application de deux couches de peinture acrylique haute qualitÃ©.</p>
...
<p className="text-slate-600 dark:text-slate-400 text-sm mb-4">Traitement des fissures et peinture mate anti-traces.</p>
<div className="flex items-baseline gap-1 border-t border-slate-100 dark:border-slate-800 pt-4">
<span className="text-sm text-slate-500">Ã  partir de</span>
...
{/*  Top Expert Painters  */}
<section className="mb-16">
<h2 className="text-slate-900 dark:text-slate-100 text-3xl font-bold leading-tight mb-8">Nos Experts en Peinture</h2>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
{/*  Expert 1  */}
<div className="flex flex-col items-center bg-white dark:bg-slate-900 p-8 rounded-xl border border-slate-200 dark:border-slate-800 text-center">
...
<p className="text-slate-500 text-sm mb-6">Expert en peinture dÃ©corative - 12 ans d'expÃ©rience</p>
<button className="w-full py-2.5 rounded-lg bg-primary/10 text-primary font-bold hover:bg-primary hover:text-white transition-colors">RÃ©server Marc</button>
</div>
{/*  Expert 2  */}
<div className="flex flex-col items-center bg-white dark:bg-slate-900 p-8 rounded-xl border border-slate-200 dark:border-slate-800 text-center shadow-lg ring-2 ring-primary">
<div className="relative mb-4">
...
<div className="absolute -top-2 left-1/2 -translate-x-1/2 bg-primary text-white text-[10px] px-2 py-1 rounded-full font-bold uppercase">Le plus demandÃ©</div>
<div className="absolute bottom-0 right-0 bg-green-500 size-5 rounded-full border-2 border-white"></div>
</div>
<h3 className="text-lg font-bold">Thomas D.</h3>
<div className="flex items-center gap-1 text-yellow-500 my-1">
<span className="material-symbols-outlined fill-1 text-sm">star</span>
<span className="text-sm font-bold text-slate-900 dark:text-slate-100">5.0</span>
<span className="text-xs text-slate-500 font-normal">(89 avis)</span>
</div>
<p className="text-slate-500 text-sm mb-6">SpÃ©cialiste rÃ©novation plafonds - 8 ans d'expÃ©rience</p>
<button className="w-full py-2.5 rounded-lg bg-primary text-white font-bold hover:opacity-90 transition-opacity">RÃ©server Thomas</button>
</div>
{/*  Expert 3  */}
<div className="flex flex-col items-center bg-white dark:bg-slate-900 p-8 rounded-xl border border-slate-200 dark:border-slate-800 text-center">
<div className="relative mb-4">
...
<div className="flex items-center gap-1 text-yellow-500 my-1">
<span className="material-symbols-outlined fill-1 text-sm">star</span>
<span className="text-sm font-bold text-slate-900 dark:text-slate-100">4.8</span>
<span className="text-xs text-slate-500 font-normal">(210 avis)</span>
</div>
<p className="text-slate-500 text-sm mb-6">Experte papier peint &amp; panoramiques - 15 ans d'expÃ©rience</p>
<button className="w-full py-2.5 rounded-lg bg-primary/10 text-primary font-bold hover:bg-primary hover:text-white transition-colors">RÃ©server Sophie</button>
</div>
</div>
</section>
{/*  FAQ Section  */}
<section className="mb-16">
<h2 className="text-slate-900 dark:text-slate-100 text-3xl font-bold leading-tight mb-8">Questions frÃ©quentes</h2>
<div className="space-y-4 max-w-3xl">
<details className="group border border-slate-200 dark:border-slate-800 rounded-xl bg-white dark:bg-slate-900 overflow-hidden" open="">
...
<div className="p-6 pt-0 text-slate-600 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800">
                                Nous utilisons principalement des peintures acryliques de marques professionnelles (Zolpan, Tollens, Little Greene) respectueuses de l'environnement (Ecolabel) et Ã  faible Ã©mission de COV.
                            </div>
</details>
...
<div className="p-6 pt-0 text-slate-600 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800">
                                Le tarif par mÂ² inclut la peinture blanche standard pour les sous-couches. Pour les couleurs spÃ©cifiques, vous pouvez soit les fournir vous-mÃªme, soit demander Ã  l'expert de les acheter pour vous (un supplÃ©ment s'appliquera alors selon le prix de la peinture choisie).
                            </div>
</details>
<details className="group border border-slate-200 dark:border-slate-800 rounded-xl bg-white dark:bg-slate-900 overflow-hidden">
<summary className="flex justify-between items-center p-6 cursor-pointer list-none">
<span className="text-lg font-bold">Combien de temps faut-il pour peindre une piÃ¨ce ?</span>
<span className="material-symbols-outlined group-open:rotate-180 transition-transform">expand_more</span>
</summary>
<div className="p-6 pt-0 text-slate-600 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800">
                                En moyenne, pour une piÃ¨ce de 12-15mÂ² comprenant les murs et le plafond, il faut compter entre 1 et 2 jours de travail, incluant la protection des meubles, la prÃ©paration des surfaces et le temps de sÃ©chage entre les couches.
                            </div>
</details>
</div>
</section>
...
{/*  Footer  */}
<footer className="bg-white dark:bg-background-dark border-t border-slate-200 dark:border-slate-800 mt-auto">
<div className="max-w-[1200px] mx-auto px-6 py-12">
<div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
<div className="flex flex-col gap-4">
<div className="flex items-center gap-2 text-primary">
<span className="material-symbols-outlined">format_paint</span>
<span className="font-bold text-xl tracking-tight text-slate-900 dark:text-white">Services Peinture</span>
</div>
<p className="text-slate-500 text-sm leading-relaxed">
                                Votre plateforme de confiance pour trouver les meilleurs artisans peintres prÃ¨s de chez vous.
                            </p>
</div>
<div>
...
<li><a className="hover:text-primary transition-colors" href="#">FaÃ§ade ExtÃ©rieure</a></li>
</ul>
</div>
<div>
...
<li><a className="hover:text-primary transition-colors" href="#">Notre Ã©quipe</a></li>
...
<a className="size-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center hover:bg-primary hover:text-white transition-all" href="#">
...
<p>Â© 2024 Services de Peinture SAS. Tous droits rÃ©servÃ©s.</p>
<div className="flex gap-6">
<a className="hover:text-slate-600" href="#">ConfidentialitÃ©</a>
<a className="hover:text-slate-600" href="#">Conditions d'utilisation</a>
<a className="hover:text-slate-600" href="#">Mentions lÃ©gales</a>
</div>
</div>
</div>
</footer>
