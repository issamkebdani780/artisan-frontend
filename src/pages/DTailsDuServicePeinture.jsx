...
<p className="text-slate-600 text-sm leading-relaxed">Choisissez votre type de projet, la surface Ã  peindre et votre date idÃ©ale en quelques clics.</p>
</div>
</div>
<div className="flex flex-col gap-4 rounded-xl border border-slate-200 bg-white p-8 hover:shadow-md transition-shadow">
<div className="text-primary bg-primary/10 w-12 h-12 rounded-lg flex items-center justify-center">
...
<p className="text-slate-600 text-sm leading-relaxed">SÃ©lectionnez un peintre qualifiÃ© parmi nos experts certifiÃ©s en consultant leurs avis et rÃ©alisations.</p>
</div>
</div>
<div className="flex flex-col gap-4 rounded-xl border border-slate-200 bg-white p-8 hover:shadow-md transition-shadow">
<div className="text-primary bg-primary/10 w-12 h-12 rounded-lg flex items-center justify-center">
...
<p className="text-slate-600 text-sm leading-relaxed">Le peintre arrive Ã  l'heure prÃ©vue, protÃ¨ge votre mobilier et rÃ©alise vos travaux avec soin.</p>
</div>
</div>
</div>
</section>
...
<p className="text-slate-600 mt-2">Prix estimÃ©s par mÂ² incluant la main d'Ã…â€œuvre et le matÃ©riel de base.</p>
</div>
...
<p className="text-slate-600 text-sm mb-4">Application de deux couches de peinture acrylique haute qualitÃ©.</p>
...
<p className="text-slate-600 text-sm mb-4">PrÃ©paration des supports et pose soignÃ©e de papier peint ou intissÃ©.</p>
<div className="flex items-baseline gap-1 border-t border-slate-100 pt-4">
<span className="text-sm text-slate-500">Ã  partir de</span>
...
{/*  FAQ Section  */}
<section className="mb-16">
<h2 className="text-slate-900 text-3xl font-bold leading-tight mb-8">Questions frÃ©quentes</h2>
