...
<p className="text-slate-200 text-lg">Safe, secure, and perfectly leveled TV mounting starting from 35 DA/h.</p>
</div>
...
<p className="text-2xl font-bold">~35 DA/h</p>
</div>
</div>
<div className="bg-white p-6 rounded-xl border border-slate-200 flex items-center gap-4">
<div className="size-12 rounded-full bg-primary/10 flex items-center justify-center text-primary">
...
<p className="text-lg font-black text-primary">38 DA/h</p>
</div>
</div>
...
<div className="text-right">
<p className="text-lg font-black text-primary">35 DA/h</p>
</div>
</div>
...
<p className="text-slate-500">Every job is covered by our 1M DA safety guarantee.</p>
</div>
</li>
<li className="flex items-start gap-3">
