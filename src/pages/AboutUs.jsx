  ...
  return (
    <div className="bg-white font-['Outfit',sans-serif]">
      ...
      <section className="py-20 px-6 md:px-20 bg-slate-50">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative group">
            ...
            />
            <div className="absolute -bottom-8 -right-8 bg-white p-8 rounded-3xl shadow-xl border border-slate-100 max-w-[240px] hidden md:block animate-bounce-slow">
      ...
      <section className="py-24 px-6 md:px-20 bg-slate-50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 max-w-7xl mx-auto font-['Outfit',sans-serif]">
          {[
