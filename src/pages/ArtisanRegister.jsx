            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar p-1">
                    {[
                      ...
                      {
                        group: "Soudure",
                        options: ["Ferronnier d�DA�art", "Soudeur arc/argon", "Chaudronnier", "Soudeur carrosserie"]
                      },
                      {
                        group: "Plomberie",
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input name="password" type="password" value={form.password} onChange={handleChange} required placeholder="�DA��DA��DA��DA��DA��DA��DA��DA�" className="w-full h-14 px-5 rounded-xl bg-[#e2e8f0] border-none focus:ring-2 focus:ring-orange-500 transition-all font-medium outline-none" />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-black uppercase tracking-[0.15em] text-slate-400 ml-1">Confirmer</label>
                  <input name="confirm" type="password" value={form.confirm} onChange={handleChange} required placeholder="�DA��DA��DA��DA��DA��DA��DA��DA�" className="w-full h-14 px-5 rounded-xl bg-[#e2e8f0] border-none focus:ring-2 focus:ring-orange-500 transition-all font-medium outline-none" />
                </div>
              </div>
