...
const Home = () => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 font-['Outfit',sans-serif]">
      <Hero />
      ...
      {/* How it works */}
      <section className="py-20 px-6 md:px-20 bg-slate-50 dark:bg-slate-800/50">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          <div className="text-center group">
            ...
            <h3 className="text-xl font-black text-slate-900 dark:text-white mb-3 tracking-tight">Décrivez votre besoin</h3>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div 
                key={idx} 
                className="border border-slate-100 dark:border-white/5 rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-shadow"
              >
                <button 
                  onClick={() => setOpenFaq(openFaq === idx ? null : idx)}
                  className="w-full flex items-center justify-between p-6 text-left bg-slate-50/50 dark:bg-slate-800/40 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors outline-none"
                >
                ...
                {openFaq === idx && (
                  <div className="p-8 bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400 text-sm leading-relaxed border-t border-slate-100 dark:border-white/5">
                    {faq.a}
                  </div>
                )}
              </div>
