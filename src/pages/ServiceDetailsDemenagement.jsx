...
<h2 className="text-xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Déménagement</h2>
</div>
...
<a className="text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-primary transition-colors" href="#">Réalisations</a>
...
<p className="text-sm font-medium text-slate-500 dark:text-slate-400">Déménagements réussis</p>
</div>
<div className="flex flex-col items-center justify-center rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-6 text-center">
...
<p className="text-sm font-medium text-slate-500 dark:text-slate-400">Protection intégrale</p>
</div>
</section>
{/*  Our Services  */}
<section>
...
<p className="mt-2 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">Solution optimale pour vos déménagements en ville ou dans la même région.</p>
</div>
<div className="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 transition-all hover:shadow-lg">
<div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10 text-primary">
...
<p className="mt-2 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">Logistique complète pour vos transferts nationaux et internationaux en toute sécurité.</p>
</div>
<div className="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 transition-all hover:shadow-lg">
<div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10 text-primary">
...
<p className="mt-2 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">Protection professionnelle de vos objets fragiles et précieux avec un matériel adapté.</p>
</div>
<div className="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 transition-all hover:shadow-lg">
<div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10 text-primary">
<span className="material-symbols-outlined">build</span>
</div>
<h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">Montage &amp; Démontage</h3>
<p className="mt-2 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">Gestion experte de votre mobilier, du démontage à la réinstallation complète.</p>
</div>
</div>
</section>
{/*  Why Choose Us  */}
...
<p className="text-slate-600 dark:text-slate-400 italic mb-6">"Une équipe ponctuelle, polie et très efficace. Mes meubles fragiles sont arrivés intacts. Je recommande vivement !"</p>
...
<p className="text-slate-600 dark:text-slate-400 italic mb-6">"Déménagement longue distance géré de main de maître. Le service d'emballage nous a fait gagner un temps précieux."</p>
<div className="flex items-center gap-3">
<div className="h-10 w-10 rounded-full bg-slate-200 overflow-hidden">
...
<p className="text-sm text-slate-500 dark:text-slate-400">Réponse en moins de 24h</p>
</div>
</div>
...
<span className="text-sm font-medium text-slate-700 dark:text-slate-300">Estimation personnalisée</span>
</div>
</div>
<div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-100 dark:border-slate-800">
<div className="flex items-center gap-3">
<span className="material-symbols-outlined text-primary">calendar_today</span>
<span className="text-sm font-medium text-slate-700 dark:text-slate-300">Disponibilité immédiate</span>
</div>
</div>
</div>
...
<p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Nos experts sont à votre écoute pour vous conseiller.</p>
...
<span className="material-symbols-outlined text-primary">local_shipping</span>
<span className="font-bold text-slate-900 dark:text-slate-100">Déménagement</span>
</div>
...
<div>
<h5 className="font-bold text-sm uppercase tracking-wider text-slate-900 dark:text-slate-100 mb-4">Légal</h5>
<ul className="space-y-2 text-sm text-slate-500">
