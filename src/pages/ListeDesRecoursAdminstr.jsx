...
<h2 className="text-slate-900 dark:text-slate-100 text-lg font-bold leading-tight tracking-tight">ArtisanDirect</h2>
</div>
<nav className="hidden md:flex items-center gap-9">
<a className="text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary text-sm font-medium transition-colors" href="#">Accueil</a>
<a className="text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary text-sm font-medium transition-colors" href="#">Missions</a>
<a className="text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary text-sm font-medium transition-colors" href="#">Support</a>
</nav>
</div>
...
<div>
<h1 className="text-slate-900 dark:text-slate-100 text-3xl md:text-4xl font-extrabold tracking-tight">Mes recours</h1>
<p className="text-slate-500 dark:text-slate-400 mt-1">Gérez vos contestations et demandes de révision administrative.</p>
</div>
...
<h3 className="font-bold text-slate-800 dark:text-slate-200">Vue d'ensemble</h3>
</div>
<div className="space-y-4">
<div className="flex justify-between items-center p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
<span className="text-sm font-medium text-slate-600 dark:text-slate-400">Total recours</span>
<span className="text-xl font-bold text-slate-900 dark:text-slate-100">12</span>
</div>
<div className="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border-l-4 border-blue-500">
<span className="text-sm font-medium text-blue-700 dark:text-blue-400">En attente</span>
<span className="text-xl font-bold text-blue-800 dark:text-blue-300">3</span>
</div>
...
<span className="text-sm font-medium text-green-700 dark:text-green-400">Terminés</span>
<span className="text-xl font-bold text-green-800 dark:text-green-300">9</span>
</div>
</div>
...
<a className="flex flex-col items-center justify-center border-b-2 border-transparent text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 pb-3 pt-2 px-1 whitespace-nowrap" href="#">
...
<th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Référence</th>
<th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Sujet</th>
<th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Date de dépôt</th>
<th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 text-center">Statut</th>
...
<span className="font-mono text-sm font-semibold text-slate-700 dark:text-slate-300">AD-784920X</span>
</td>
<td className="px-6 py-5">
<div className="text-sm font-medium text-slate-900 dark:text-slate-100">Contestation de constat</div>
<div className="text-xs text-slate-500">Chantier #2901 - Paris</div>
</td>
<td className="px-6 py-5 text-sm text-slate-600 dark:text-slate-400">12/10/2023</td>
...
<tr className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
<td className="px-6 py-5">
<span className="font-mono text-sm font-semibold text-slate-700 dark:text-slate-300">AD-552109Y</span>
</td>
<td className="px-6 py-5">
<div className="text-sm font-medium text-slate-900 dark:text-slate-100">Litige paiement</div>
<div className="text-xs text-slate-500">Facture F-2023-44</div>
</td>
<td className="px-6 py-5 text-sm text-slate-600 dark:text-slate-400">05/09/2023</td>
<td className="px-6 py-5 text-center">
...
<tr className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
<td className="px-6 py-5">
<span className="font-mono text-sm font-semibold text-slate-700 dark:text-slate-300">AD-334012Z</span>
</td>
<td className="px-6 py-5">
<div className="text-sm font-medium text-slate-900 dark:text-slate-100">Erreur administrative</div>
<div className="text-xs text-slate-500">Mise à jour profil</div>
</td>
<td className="px-6 py-5 text-sm text-slate-600 dark:text-slate-400">20/08/2023</td>
<td className="px-6 py-5 text-center">
<span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-slate-100 text-slate-800 dark:bg-slate-800 dark:text-slate-300">
                                                Clos
                                            </span>
</td>
<td className="px-6 py-5 text-right">
...
<tr className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
<td className="px-6 py-5">
<span className="font-mono text-sm font-semibold text-slate-700 dark:text-slate-300">AD-110293W</span>
</td>
<td className="px-6 py-5">
<div className="text-sm font-medium text-slate-900 dark:text-slate-100">Défaut de matériel</div>
<div className="text-xs text-slate-500">Garantie fournisseur</div>
</td>
<td className="px-6 py-5 text-sm text-slate-600 dark:text-slate-400">15/07/2023</td>
<td className="px-6 py-5 text-center">
<span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-red-100 text-red-800 dark:bg-red-900/40 dark:text-red-300">
                                                Rejeté
                                            </span>
</td>
<td className="px-6 py-5 text-right">
...
<button className="p-1 rounded border border-slate-300 dark:border-slate-700">
...
<span className="text-lg font-bold text-slate-900 dark:text-slate-100">ArtisanDirect</span>
</div>
...
<div>
<h4 className="font-bold text-slate-900 dark:text-slate-100 mb-6">Navigation</h4>
...
<div>
<h4 className="font-bold text-slate-900 dark:text-slate-100 mb-6">Support Admin</h4>
<ul className="space-y-4 text-sm text-slate-600 dark:text-slate-400">
...
<div>
<h4 className="font-bold text-slate-900 dark:text-slate-100 mb-6">Restez connecté</h4>
<div className="flex gap-4">
<a className="size-9 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-600 dark:text-slate-400 hover:bg-primary hover:text-white transition-all" href="#">
