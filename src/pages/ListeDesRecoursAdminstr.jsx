...
<p className="text-slate-500 mt-1">GÃ©rez vos contestations et demandes de rÃ©vision administrative.</p>
</div>
...
<span className="text-sm font-medium text-green-700">TerminÃ©s</span>
...
<a className="flex flex-col items-center justify-center border-b-2 border-transparent text-slate-500 hover:text-slate-700 pb-3 pt-2 px-1 whitespace-nowrap" href="#">
<span className="text-sm font-bold">AcceptÃ©s</span>
</a>
<a className="flex flex-col items-center justify-center border-b-2 border-transparent text-slate-500 hover:text-slate-700 pb-3 pt-2 px-1 whitespace-nowrap" href="#">
...
<th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500">RÃ©fÃ©rence</th>
<th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500">Sujet</th>
<th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500">Date de dÃ©pÃ´t</th>
...
<button className="text-primary hover:text-primary/80 font-bold text-sm flex items-center gap-1 ml-auto transition-colors">
                                                DÃ©tails <span className="material-symbols-outlined text-sm">chevron_right</span>
</button>
</td>
</tr>
{/*  Row 2  */}
...
<div className="text-xs text-slate-500">Mise Ã  jour profil</div>
</td>
...
<td className="px-6 py-5">
<div className="text-sm font-medium text-slate-900">DÃ©faut de matÃ©riel</div>
...
<p className="text-sm text-slate-500 leading-relaxed">
                            La plateforme leader pour les artisans indÃ©pendants. Gagnez en visibilitÃ© et simplifiez votre administratif.
                        </p>
</div>
<div>
...
<li><a className="hover:text-primary transition-colors" href="#">ParamÃ¨tres</a></li>
</ul>
</div>
<div>
...
<li><a className="hover:text-primary transition-colors" href="#">Documents lÃ©gaux</a></li>
</ul>
</div>
<div>
<h4 className="font-bold text-slate-900 mb-6">Restez connectÃ©</h4>
...
<p>Â© 2023 ArtisanDirect. Tous droits rÃ©servÃ©s.</p>
