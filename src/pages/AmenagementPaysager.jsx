...
<p className="text-xs text-slate-500">Détails du service</p>
</div>
</div>
...
<p className="text-sm text-white/80 mb-4 leading-relaxed">Nos experts vous répondent sous 24h pour étudier votre projet.</p>
...
<h1 className="text-white text-3xl md:text-4xl font-black leading-tight">Aménagement Paysager Professionnel</h1>
<p className="text-white/80 mt-2 max-w-lg">Transformez votre extérieur en un havre de paix durable et esthétique.</p>
</div>
</section>
{/*  Expertise Section  */}
...
<p className="text-xs text-slate-500 mt-1">Spécialiste en écosystèmes durables et potagers urbains.</p>
</div>
</div>
</div>
</section>
...
<li className="flex items-start gap-2 text-sm"><span className="material-symbols-outlined text-primary text-lg">check_circle</span> Liste des végétaux conseillés</li>
</ul>
...
<p className="text-3xl font-black text-primary mb-4">890€ <span className="text-sm font-normal text-slate-500">/ projet</span></p>
<ul className="space-y-3 mb-6 flex-1">
