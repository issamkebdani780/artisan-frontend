...
<input className="w-full pl-10 pr-4 py-2 bg-slate-100 border-none rounded-xl text-sm focus:ring-2 focus:ring-purple-500" placeholder="Rechercher des paramÃ¨tres..." type="text"/>
</div>
<div className="flex items-center gap-2">
...
{/*  Title Section  */}
<div className="mb-8">
<h1 className="text-3xl font-black tracking-tight text-slate-900">ParamÃ¨tres SystÃ¨me</h1>
<p className="text-slate-500 mt-2">GÃ©rez la configuration globale de The Violet Protocol et ajustez les prÃ©fÃ©rences systÃ¨me de votre environnement.</p>
</div>
{/*  Tabbed Navigation  */}
...
<button className="px-6 py-4 text-sm font-medium text-slate-500 hover:text-purple-600 transition-colors">SÃ©curitÃ©</button>
...
<p className="text-xs text-slate-500 mt-1">ÃŠtre informÃ© dÃ¨s qu'un nouveau litige est ouvert entre un client et un artisan.</p>
</div>
<label className="inline-flex items-center cursor-pointer">
<input defaultChecked className="sr-only peer" type="checkbox"/>
<div className="relative w-11 h-6 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple-600"></div>
...
<p className="text-xs text-slate-500 mt-1">Recevoir un rÃ©sumÃ© des activitÃ©s systÃ¨me chaque lundi matin.</p>
</div>
<label className="inline-flex items-center cursor-pointer">
...
<div>
<p className="text-sm font-bold">Alertes de sÃ©curitÃ©</p>
<p className="text-xs text-slate-500 mt-1">Notifications immÃ©diates pour les tentatives de connexion suspectes.</p>
</div>
<label className="inline-flex items-center cursor-pointer">
<input defaultChecked className="sr-only peer" type="checkbox"/>
<div className="relative w-11 h-6 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple-600"></div>
...
<div>
<p className="text-sm font-bold">Maintenance du systÃ¨me</p>
<p className="text-xs text-slate-500 mt-1">Alertes concernant les maintenances planifiÃ©es et les mises Ã  jour.</p>
</div>
<label className="inline-flex items-center cursor-pointer">
<input defaultChecked className="sr-only peer" type="checkbox"/>
<div className="relative w-11 h-6 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple-600"></div>
...
{/*  PrÃ©fÃ©rences de frÃ©quence  */}
<section className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm">
<div className="flex items-center gap-3 mb-8">
<span className="material-symbols-outlined text-purple-600">schedule</span>
<h2 className="text-xl font-bold">PrÃ©fÃ©rences de frÃ©quence</h2>
</div>
...
<input defaultChecked className="sr-only peer" name="frequency" type="radio" value="instantanÃ©"/>
<span className="text-sm font-bold mb-1">InstantanÃ©</span>
<span className="text-[10px] text-slate-500 uppercase tracking-wide">DÃ¨s que l'Ã©vÃ©nement survient</span>
...
<span className="text-[10px] text-slate-500 uppercase tracking-wide">RÃ©sumÃ© quotidien Ã  18h00</span>
<span className="absolute top-4 right-4 text-purple-600 hidden peer-checked:block">
<span className="material-symbols-outlined text-base">check_circle</span>
</span>
</label>
...
<span className="text-[10px] text-slate-500 uppercase tracking-wide">RÃ©sumÃ© chaque lundi matin</span>
<span className="absolute top-4 right-4 text-purple-600 hidden peer-checked:block">
<span className="material-symbols-outlined text-base">check_circle</span>
</span>
</label>
...
<h3 className="font-bold text-slate-900">Informations SystÃ¨me</h3>
