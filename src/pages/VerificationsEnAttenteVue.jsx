...
<input className="pl-10 pr-4 py-2 rounded-xl border-slate-200 bg-slate-50 text-sm focus:ring-primary focus:border-primary w-72 transition-all" placeholder="Rechercher un artisan..." type="text"/>
</div>
<div className="flex items-center gap-3 border-l border-slate-200 pl-6">
<div className="text-right">
<p className="text-sm font-bold text-slate-900">Admin User</p>
<p className="text-xs font-bold text-indigo-600 uppercase tracking-wider mb-1">Administrateur</p>
</div>
...
<div>
<p className="text-xs font-bold text-indigo-600 uppercase tracking-wider mb-1">Dossiers en attente</p>
...
<td className="px-6 py-4 text-sm text-slate-600">12/10/2023</td>
<td className="px-6 py-4">
...
<td className="px-6 py-4">
<span className="px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-amber-100 text-amber-700">En attente</span>
</td>
...
<td className="px-6 py-4 text-sm text-slate-600">11/10/2023</td>
<td className="px-6 py-4">
<div className="flex flex-wrap gap-2">
<span className="px-2 py-1 rounded-md bg-slate-100 text-[10px] font-bold text-slate-600 border border-slate-200 flex items-center gap-1">
...
<td className="px-6 py-4 text-sm text-slate-600">10/10/2023</td>
<td className="px-6 py-4">
<div className="flex flex-wrap gap-2">
<span className="px-2 py-1 rounded-md bg-slate-100 text-[10px] font-bold text-slate-600 border border-slate-200 flex items-center gap-1">
<span className="material-symbols-outlined text-sm">description</span> KBIS
...
<td className="px-6 py-4 text-sm text-slate-600">09/10/2023</td>
<td className="px-6 py-4">
<div className="flex flex-wrap gap-2">
<span className="px-2 py-1 rounded-md bg-slate-100 text-[10px] font-bold text-slate-600 border border-slate-200 flex items-center gap-1">
<span className="material-symbols-outlined text-sm">badge</span> ID
...
<button className="w-8 h-8 rounded border border-slate-200 flex items-center justify-center text-slate-400 hover:bg-white">
...
<button className="w-8 h-8 rounded border border-slate-200 flex items-center justify-center text-xs font-bold hover:bg-white">2</button>
<button className="w-8 h-8 rounded border border-slate-200 flex items-center justify-center text-xs font-bold hover:bg-white">3</button>
<button className="w-8 h-8 rounded border border-slate-200 flex items-center justify-center text-slate-400 hover:bg-white">
