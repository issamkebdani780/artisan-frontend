...
<input className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-slate-900 dark:text-white focus:outline-0 focus:ring-0 border-none bg-transparent placeholder:text-slate-400 px-4 rounded-l-none pl-2 text-sm font-normal" placeholder="Rechercher..." value=""/>
</div>
</label>
</div>
<div className="flex flex-1 justify-end gap-4 md:gap-6">
<div className="flex gap-2">
<button className="flex items-center justify-center rounded-xl h-10 w-10 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
...
{/*  Navigation Tabs  */}
<div className="bg-white dark:bg-background-dark border-b border-slate-200 dark:border-slate-800 px-6 md:px-10">
<div className="flex overflow-x-auto no-scrollbar gap-8">
<a className="flex flex-col items-center justify-center border-b-[3px] border-transparent text-slate-500 dark:text-slate-400 pb-3 pt-4 whitespace-nowrap hover:text-primary transition-colors" href="#">
...
<h1 className="text-slate-900 dark:text-white text-3xl md:text-4xl font-black leading-tight tracking-[-0.033em]">Configuration Plateforme</h1>
...
<h2 className="text-slate-900 dark:text-white text-xl font-bold">Paramètres Financiers</h2>
</div>
<div className="space-y-4">
<div className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50">
<span className="text-slate-600 dark:text-slate-400 text-sm">Devise par défaut</span>
<div className="flex items-center gap-2">
<span className="text-slate-900 dark:text-white font-medium">Euro (EUR)</span>
<button className="material-symbols-outlined text-slate-400 hover:text-primary text-sm">edit</button>
</div>
</div>
<div className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50">
<span className="text-slate-600 dark:text-slate-400 text-sm">TVA (%)</span>
<div className="flex items-center gap-2">
<span className="text-slate-900 dark:text-white font-medium">20.0%</span>
<button className="material-symbols-outlined text-slate-400 hover:text-primary text-sm">edit</button>
</div>
</div>
<div className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50">
<span className="text-slate-600 dark:text-slate-400 text-sm">Seuil de paiement</span>
<div className="flex items-center gap-2">
<span className="text-slate-900 dark:text-white font-medium">50.00 €</span>
<button className="material-symbols-outlined text-slate-400 hover:text-primary text-sm">edit</button>
</div>
</div>
</div>
...
<h2 className="text-slate-900 dark:text-white text-xl font-bold">Langues &amp; Localisation</h2>
</div>
<div className="space-y-4">
<div className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50">
<span className="text-slate-600 dark:text-slate-400 text-sm">Langue principale</span>
<select className="bg-transparent border-none text-slate-900 dark:text-white text-sm font-medium focus:ring-0">
...
<div className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50">
<span className="text-slate-600 dark:text-slate-400 text-sm">Fuseau horaire</span>
<div className="flex items-center gap-2">
<span className="text-slate-900 dark:text-white font-medium">(GMT+01:00) Paris</span>
<button className="material-symbols-outlined text-slate-400 hover:text-primary text-sm">edit</button>
</div>
</div>
<div className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50">
<span className="text-slate-600 dark:text-slate-400 text-sm">Format de date</span>
<div className="flex items-center gap-2">
<span className="text-slate-900 dark:text-white font-medium">JJ/MM/AAAA</span>
...
<section className="bg-white dark:bg-slate-900/50 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm lg:col-span-2">
<div className="flex items-center justify-between mb-8">
<div className="flex items-center gap-3">
<span className="material-symbols-outlined text-primary bg-primary/10 p-2 rounded-lg">security</span>
<h2 className="text-slate-900 dark:text-white text-xl font-bold">Sécurité de la Plateforme</h2>
</div>
<span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 rounded-full text-xs font-bold uppercase tracking-wider">État : Sécurisé</span>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
<div className="flex flex-col gap-3 p-4 border border-slate-100 dark:border-slate-800 rounded-xl hover:border-primary/30 transition-all group">
...
<h3 className="text-slate-900 dark:text-white font-bold text-sm">Double Authentification (2FA)</h3>
<p className="text-slate-500 dark:text-slate-400 text-xs">Exiger le 2FA pour tous les administrateurs.</p>
...
<h3 className="text-slate-900 dark:text-white font-bold text-sm">Complexité de Mot de Passe</h3>
<p className="text-slate-500 dark:text-slate-400 text-xs">Niveau minimum : Fort (12+ caractères).</p>
<div className="mt-2 flex items-center gap-2">
<button className="bg-slate-200 dark:bg-slate-800 px-3 py-1 text-slate-700 dark:text-slate-300 text-[10px] font-bold rounded">CONFIGURER</button>
</div>
</div>
<div className="flex flex-col gap-3 p-4 border border-slate-100 dark:border-slate-800 rounded-xl hover:border-primary/30 transition-all group">
<div className="flex items-center justify-between">
...
<h3 className="text-slate-900 dark:text-white font-bold text-sm">Expiration de Session</h3>
<p className="text-slate-500 dark:text-slate-400 text-xs">Déconnexion automatique après 30 minutes.</p>
<div className="mt-2 flex items-center gap-2">
<button className="bg-slate-200 dark:bg-slate-800 px-3 py-1 text-slate-700 dark:text-slate-300 text-[10px] font-bold rounded">MODIFIER</button>
</div>
</div>
</div>
</section>
...
<button className="px-6 py-2.5 bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold rounded-xl hover:bg-slate-300 dark:hover:bg-slate-700 transition-all">Réinitialiser</button>
</div>
