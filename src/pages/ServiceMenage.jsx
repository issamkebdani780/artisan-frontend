...
<h2 className="text-slate-900 dark:text-white text-xl font-bold leading-tight tracking-tight">M̩nage</h2>
</div>
...
<a className="text-slate-700 dark:text-slate-200 text-sm font-medium hover:text-primary transition-colors" href="#">R̩alisations</a>
...
<span className="text-slate-600 dark:text-slate-400 text-sm">Personnel qualifi̩ et v̩rifi̩</span>
</li>
<li className="flex items-start gap-3">
<span className="material-symbols-outlined text-primary text-sm mt-1">check_circle</span>
<span className="text-slate-600 dark:text-slate-400 text-sm">Produits ̩co-responsables</span>
</li>
<li className="flex items-start gap-3">
<span className="material-symbols-outlined text-primary text-sm mt-1">check_circle</span>
<span className="text-slate-600 dark:text-slate-400 text-sm">Sans engagement de dur̩e</span>
</li>
</ul>
</div>
</div>
...
<p className="text-slate-500 dark:text-slate-400 text-sm font-medium uppercase tracking-wider">Maisons nettoy̩es</p>
...
<h4 className="text-slate-900 dark:text-white text-xl font-bold mb-2">M̩nage r̩gulier</h4>
...
<p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Un grand nettoyage de printemps pour d̩sinfecter et assainir chaque recoin.</p>
</div>
<div className="group p-6 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-primary transition-all">
<div className="size-12 rounded-lg bg-primary/10 flex items-center justify-center text-primary mb-4">
...
<p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Lavage de vitres professionnel pour une transparence ̩clatante et sans traces.</p>
</div>
<div className="group p-6 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-primary transition-all">
<div className="size-12 rounded-lg bg-primary/10 flex items-center justify-center text-primary mb-4">
...
<p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Soin du linge et repassage soign̩ pour vous lib̩rer de cette corv̩e quotidienne.</p>
</div>
</div>
</section>
{/*  Testimonials  */}
