...
{/*  Navigation  */}
<header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-primary/10 px-6 md:px-20 py-4 bg-white">
...
<h3 className="text-slate-900 text-lg font-bold mb-4">Pourquoi nous choisir ?</h3>
...
<div className="flex flex-col gap-2 rounded-xl p-8 border border-primary/10 bg-white shadow-sm text-center">
<p className="text-slate-500 text-sm font-medium uppercase tracking-wider">Assurance</p>
...
<h2 className="text-slate-900 text-3xl font-bold tracking-tight">Nos Services</h2>
...
<h2 className="text-slate-900 text-3xl font-bold mb-8 text-center">Ce que nos clients disent</h2>
...
<div>
<p className="text-slate-900 text-sm font-bold">Marie Laurent</p>
<p className="text-slate-500 text-xs">Cliente depuis 2 ans</p>
</div>
</div>
</div>
<div className="bg-white p-6 rounded-xl shadow-sm italic relative">
...
<div>
<p className="text-slate-900 text-sm font-bold">Thomas Dubois</p>
<p className="text-slate-500 text-xs">Client ponctuel</p>
</div>
</div>
</div>
</div>
