      ...
      <div className="p-4 md:p-8 flex-1 flex flex-col overflow-y-auto font-['Outfit',sans-serif]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-10">
          <div>
            ...
            <p className="text-slate-400 font-medium text-sm max-w-md">GÃ©rez vos prestations et dÃ©finissez vos prix pour attirer les meilleurs clients.</p>
          </div>
          <button 
          ...
          {loading ? (
            ...
            <div className="py-24 text-center bg-white rounded-[2rem] border-2 border-dashed border-slate-200 relative overflow-hidden group">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-black text-slate-900 mb-2">Aucun service crÃ©Ã©</h3>
                <p className="text-slate-400 font-medium mb-8 max-w-sm mx-auto text-sm">CrÃ©ez votre premier service pour que les clients puissent voir vos offres et tarifs.</p>
                <button 
                  onClick={() => handleOpenModal()}
                ...
                <div className="relative p-8 flex justify-between items-center">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 font-bold uppercase tracking-widest">{currentService ? 'Mise Ã  jour' : 'Ajout de prestation'}</p>
                    </div>
                  </div>
              ...
              <form onSubmit={handleSubmit} className="p-8 pt-6 space-y-6 overflow-y-auto max-h-[70vh] custom-scrollbar">
                ...
                <div className="grid grid-cols-5 gap-5">
                  <div className="col-span-3 flex flex-col gap-2.5">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">CatÃ©gorie</label>
                    <div className="relative">
                      <select 
                        name="category_id" 
