...
const ArtisanLogin = () => {
  ...
  return (
    <div className="bg-[#f8f9fc] w-full min-h-screen flex items-center justify-center relative overflow-x-hidden py-20 px-4 font-['Outfit',sans-serif] transition-colors">
      {/* Background Decor */}
      ...
      <main className="w-full max-w-[640px] relative z-10">
        {/* Login Card */}
        <div className="bg-white rounded-3xl shadow-[0_25px_50px_-12px_rgba(16,24,40,0.08)] p-8 md:p-16 flex flex-col gap-12 border border-slate-200/60 transition-colors">
          ...
          {error && (
            <div className="mb-4 p-4 bg-red-50 border-l-4 border-red-500 text-red-700 flex items-center gap-3 transition-colors">
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <label htmlFor="email" className="text-xs font-bold uppercase tracking-[0.15em] text-slate-500 flex items-center gap-2 px-1 transition-colors">
              ...
              {/* Password Field */}
              <div className="space-y-3">
                <label htmlFor="password" className="text-xs font-bold uppercase tracking-[0.15em] text-slate-500 flex items-center gap-2 px-1 transition-colors">
          ...
          {/* Footer Prompt */}
          <div className="text-center text-lg text-slate-500 transition-colors">
        ...
        {/* Trust Badge */}
        <div className="mt-10 p-6 bg-white/80 backdrop-blur-md border border-white/50 rounded-2xl flex gap-5 items-center shadow-[0_25px_50px_-12px_rgba(16,24,40,0.08)] transition-colors">
