...
<p className="text-white/90 text-sm font-medium">Plus de 1,200 installations réussies cette année</p>
</div>
...
<li className="flex items-center gap-2"><span className="material-symbols-outlined text-green-500 text-sm">check_circle</span> Test d'étanchéité</li>
</ul>
...
<div className="text-3xl font-black mb-6">129€ <span className="text-sm font-normal text-white/70">TTC</span></div>
<ul className="space-y-3 mb-8 text-sm">
...
<div>
<h6 className="text-white font-bold mb-6">Légal</h6>
<ul className="space-y-4 text-sm">
