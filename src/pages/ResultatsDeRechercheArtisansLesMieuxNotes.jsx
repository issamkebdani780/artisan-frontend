...
<h2 className="text-slate-900 text-xl font-bold leading-tight tracking-[-0.015em]">Artisanat</h2>
</div>
<div className="hidden md:flex items-center gap-6">
<a className="text-slate-600 hover:text-primary text-sm font-medium leading-normal" href="#">Prix</a>
<button className="flex items-center gap-2 text-slate-600 hover:text-primary text-sm font-medium leading-normal">
...
<input className="form-input flex w-full min-w-0 flex-1 border-none bg-slate-100 focus:ring-0 h-full placeholder:text-slate-500 px-4 rounded-r-lg text-base font-normal" placeholder="Rechercher un artisan..." value=""/>
</div>
</label>
...
<div className="mt-8">
<h4 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4">Score Minimum</h4>
...
<div className="absolute top-3 left-3 bg-white/90 backdrop-blur px-2 py-1 rounded text-[10px] font-bold text-primary uppercase tracking-widest border border-primary/20">Menuisier</div>
</div>
...
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-100">
...
{/*  Footer (Optional)  */}
<footer className="bg-white border-t border-slate-200 py-10 px-4 md:px-10 lg:px-20 mt-12">
