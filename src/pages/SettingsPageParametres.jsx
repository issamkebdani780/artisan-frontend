...
{/*  Top Navigation Bar  */}
<header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 bg-white px-6 py-3 lg:px-10">
...
<button className="flex size-10 cursor-pointer items-center justify-center rounded-lg bg-slate-100 text-slate-700">
...
<div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 border border-slate-200" data-alt="Photo de profil de l'artisan" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuBeqZpBu2fKC2_qj08TJ3wSigyAcZW73NJyxhsZ16whpoYqdOq89dr8ahPkloIg7zlvpAuP3ijquhzwBREE964RDCsSa_g1nhasnM6Hf412ZhuvecdWn3VK02sY-Qw-2K2HG1b-RL6SvSBRCp73hxiIjNYtkhqYxACu9QvrX-C2vtmyAuWAMtHsXKJ7mjDCKbR7pwfkOU-HKpJT34qFRdKEte2K2yGS24zmyQq7Ga2BXMl4VrLy1P-aRGlXrxXBI_MgCVoEEeByDEl1");'></div>
</div>
</header>
<div className="flex flex-1 flex-col lg:flex-row">
{/*  Sidebar  */}
<aside className="w-full lg:w-80 bg-white border-r border-slate-200 p-6 flex flex-col gap-6">
<div className="flex flex-col gap-1">
<h1 className="text-slate-900 text-base font-bold">Jean Dupont</h1>
<p className="text-slate-500 text-sm">Artisan Menuisier</p>
</div>
<nav className="flex flex-col gap-1">
<a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-700 hover:bg-slate-50 transition-colors" href="#">
...
<input className="w-full rounded-lg border-slate-300 focus:ring-primary focus:border-primary" placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢" type="password"/>
</div>
<div className="flex flex-col gap-1.5">
...
<div className="flex flex-col gap-1.5">
<label className="text-sm font-semibold text-slate-700">Confirmer le nouveau</label>
<input className="w-full rounded-lg border-slate-300 focus:ring-primary focus:border-primary" placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢" type="password"/>
</div>
</div>
</div>
...
<div>
<p className="text-sm font-bold text-slate-900">Notifications par Email</p>
<p className="text-xs text-slate-500">Recevez des rapports et alertes par mail</p>
</div>
...
<button className="w-full sm:w-auto px-6 py-2.5 text-sm font-bold text-slate-700 hover:bg-slate-100 rounded-lg transition-colors" type="button">
                                Annuler
                            </button>
