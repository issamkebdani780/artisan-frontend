...
<div className="mb-6">
<h1 className="text-slate-900 text-lg font-bold">RÃ©paration de Fuites</h1>
...
<span className="material-symbols-outlined text-base">chevron_right</span>
<span className="text-slate-900 font-semibold">RÃ©paration de Fuites</span>
</nav>
{/*  Details Section  */}
...
<div>
<p className="font-bold text-slate-900">DÃ©lai d'intervention</p>
...
<p className="mt-2 text-slate-600 text-sm leading-relaxed">
                                Oui, toutes nos rÃ©parations de fuites sont couvertes par une garantie piÃ¨ces et main d'Ã…â€œuvre de 2 ans, en plus de l'assurance dÃ©cennale obligatoire.
                            </p>
</div>
<div className="pb-2">
<button className="w-full text-left font-bold text-slate-900 flex justify-between items-center group">
