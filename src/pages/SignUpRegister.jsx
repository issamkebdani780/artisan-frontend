...
<h2 className="text-slate-900 text-xl font-bold leading-tight tracking-tight">Platform</h2>
</div>
<div className="flex items-center gap-4">
...
<h1 className="text-slate-900 text-4xl font-black leading-tight tracking-tight">Create New Account</h1>
<p className="text-slate-500 text-lg">Join our community of experts and clients.</p>
</div>
<div className="bg-white p-6 md:p-8 rounded-xl border border-slate-200 shadow-sm">
<div className="mb-8">
<label className="text-slate-900 text-lg font-bold block mb-4">I am signing up as a:</label>
<div className="flex h-12 w-full items-center justify-center rounded-lg bg-slate-100 p-1">
<label className="flex cursor-pointer h-full grow items-center justify-center overflow-hidden rounded-md px-2 has-[:checked]:bg-white has-[:checked]:shadow-sm has-[:checked]:text-primary text-slate-500 text-sm font-bold transition-all">
...
<div>
<label className="block text-sm font-bold text-slate-700 mb-2">Professional Skillset</label>
<div className="relative">
<span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">construction</span>
<input className="w-full pl-10 pr-4 py-3 rounded-lg border border-slate-200 bg-white focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all" placeholder="e.g. Master Carpenter, Plumber" type="text"/>
</div>
</div>
<div>
<label className="block text-sm font-bold text-slate-700 mb-2">Years of Experience</label>
<select className="w-full px-4 py-3 rounded-lg border border-slate-200 bg-white focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all appearance-none">
...
<div>
<label className="block text-sm font-bold text-slate-700 mb-2">Verification Documents</label>
<div className="border-2 border-dashed border-slate-300 rounded-xl p-8 text-center bg-slate-50 hover:border-primary/50 transition-colors cursor-pointer group">
...
<button className="w-full sm:w-1/3 py-3 rounded-lg border border-slate-200 text-slate-700 font-bold hover:bg-slate-50 transition-colors">
                                    Back
                                </button>
...
<p className="font-bold text-slate-900">Why do we need this?</p>
...
<p className="text-slate-400 text-xs">Â© 2024 Platform Inc. All rights reserved. â€¢ Privacy Policy â€¢ Terms of Service</p>
</footer>
</div>
</div>
