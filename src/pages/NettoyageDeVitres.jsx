...
<p className="text-sm text-slate-600 leading-snug">Besoin d'aide pour un devis spécifique ?</p>
...
<p className="text-sm text-slate-600 leading-relaxed">Notre système de filtration déminéralise l'eau pour un séchage naturel sans aucune trace ni dépôt minéral.</p>
</div>
</div>
<div className="flex gap-6">
<div className="shrink-0 size-12 bg-primary/10 rounded-full flex items-center justify-center text-primary">
...
<p className="text-sm text-slate-600 leading-relaxed">Nous atteignons jusqu'à 20 mètres de hauteur depuis le sol, garantissant sécurité et rapidité d'exécution.</p>
</div>
</div>
<div className="flex gap-6">
<div className="shrink-0 size-12 bg-primary/10 rounded-full flex items-center justify-center text-primary">
...
<p className="text-sm text-slate-600 leading-relaxed">Traitement optionnel pour réduire la chaleur et protéger votre mobilier de la décoloration solaire.</p>
</div>
</div>
</div>
