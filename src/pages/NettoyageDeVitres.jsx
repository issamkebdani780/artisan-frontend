...
{/*  Sidebar Navigation  */}
<aside className="hidden lg:flex w-80 flex-col bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 sticky top-0 h-screen">
...
<h1 className="text-slate-900 dark:text-white text-lg font-bold leading-none">AquaShine Pro</h1>
<p className="text-slate-500 dark:text-slate-400 text-xs font-medium">Experts en Nettoyage</p>
</div>
</div>
{/*  Nav Links  */}
...
<span className="text-sm font-semibold">Sécurité &amp; Garanties</span>
</a>
<a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-primary/10 hover:text-primary transition-colors" href="#">
...
<p className="text-sm text-slate-600 dark:text-slate-400 leading-snug">Besoin d'aide pour un devis spécifique ?</p>
...
{/*  Header  */}
<header className="sticky top-0 z-10 flex items-center justify-between bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-6 py-4">
<div className="flex items-center gap-4">
<button className="lg:hidden text-slate-600">
<span className="material-symbols-outlined">menu</span>
</button>
<div className="flex flex-col">
<h2 className="text-slate-900 dark:text-white text-xl font-bold tracking-tight">Nettoyage de Vitres</h2>
...
<input className="pl-10 pr-4 py-2 bg-slate-100 dark:bg-slate-800 border-none rounded-full text-sm focus:ring-2 focus:ring-primary w-64" placeholder="Rechercher un service..." type="text"/>
</div>
<div className="flex gap-2">
<button className="p-2 bg-slate-100 dark:bg-slate-800 rounded-full text-slate-600 dark:text-slate-300 relative">
...
<span className="text-sm font-bold">Résidentiel</span>
</button>
<button className="flex flex-col items-center border-b-2 border-transparent text-slate-500 hover:text-slate-900 dark:hover:text-white pb-4 px-2 transition-all">
...
{/*  Card 1  */}
<div className="flex flex-col bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-8 shadow-sm hover:shadow-xl transition-all group">
<div className="size-14 rounded-2xl bg-teal-50 dark:bg-teal-900/30 flex items-center justify-center text-primary mb-6 group-hover:scale-110 transition-transform">
...
<button className="w-full py-3 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white font-bold hover:bg-primary hover:text-white transition-colors">Choisir ce plan</button>
</div>
{/*  Card 2  */}
<div className="flex flex-col bg-white dark:bg-slate-900 rounded-2xl border-2 border-primary p-8 shadow-xl relative scale-105 z-10">
...
<div className="flex items-baseline gap-1 mb-6">
<span className="text-4xl font-black text-slate-900 dark:text-white">Sur devis</span>
</div>
<ul className="flex flex-col gap-4 mb-8 flex-1">
<li className="flex items-start gap-3 text-sm text-slate-600 dark:text-slate-400">
<span className="material-symbols-outlined text-primary text-lg">check_circle</span>
                        Accès télescopique &amp; nacelle
                    </li>
<li className="flex items-start gap-3 text-sm text-slate-600 dark:text-slate-400">
<span className="material-symbols-outlined text-primary text-lg">check_circle</span>
...
<button className="w-full py-3 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white font-bold hover:bg-primary hover:text-white transition-colors">Demander un devis</button>
</div>
</section>
{/*  Equipment Section  */}
...
<h2 className="text-3xl font-black text-slate-900 dark:text-white mb-4">Équipement de Pointe</h2>
...
<p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">Notre système de filtration déminéralise l'eau pour un séchage naturel sans aucune trace ni dépôt minéral.</p>
</div>
</div>
<div className="flex gap-6">
<div className="shrink-0 size-12 bg-primary/10 rounded-full flex items-center justify-center text-primary">
...
<div>
<h4 className="text-lg font-bold mb-1">Perches Télescopiques Carbone</h4>
<p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">Nous atteignons jusqu'à 20 mètres de hauteur depuis le sol, garantissant sécurité et rapidité d'exécution.</p>
</div>
</div>
<div className="flex gap-6">
<div className="shrink-0 size-12 bg-primary/10 rounded-full flex items-center justify-center text-primary">
...
<p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">Traitement optionnel pour réduire la chaleur et protéger votre mobilier de la décoloration solaire.</p>
</div>
</div>
</div>
...
<div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-2xl border border-primary/20 max-w-[200px]">
...
<p className="text-xs text-teal-200">Spécialiste Haute Hauteur (8 ans exp.)</p>
</div>
...
<p className="text-xs text-teal-200">Experte Résidentiel (5 ans exp.)</p>
</div>
<div className="ml-auto flex items-center gap-1 bg-white/20 px-2 py-1 rounded-lg">
<span className="material-symbols-outlined text-xs fill-1">star</span>
...
<p className="mt-8 text-sm text-teal-100 font-medium">Tous nos techniciens sont formés aux normes de sécurité les plus strictes et assurés.</p>
</div>
{/*  Security  */}
...
<div className="p-5 bg-background-light dark:bg-slate-800 rounded-2xl text-center">
...
<p className="text-[10px] text-slate-500">Protection intégrale de vos biens lors de l'intervention.</p>
</div>
<div className="p-5 bg-background-light dark:bg-slate-800 rounded-2xl text-center">
...
<p className="text-[10px] text-slate-500">Une trace oubliée ? On repasse gratuitement sous 48h.</p>
</div>
<div className="p-5 bg-background-light dark:bg-slate-800 rounded-2xl text-center">
<span className="material-symbols-outlined text-primary mb-2 text-3xl">eco</span>
<h5 className="text-sm font-bold mb-1">Zéro Chimie</h5>
<p className="text-[10px] text-slate-500">Sécurisé pour vos enfants, animaux et plantes.</p>
</div>
<div className="p-5 bg-background-light dark:bg-slate-800 rounded-2xl text-center">
<span className="material-symbols-outlined text-primary mb-2 text-3xl">task_alt</span>
<h5 className="text-sm font-bold mb-1">Checklist Qualité</h5>
<p className="text-[10px] text-slate-500">Chaque vitre est vérifiée selon 5 points de contrôle.</p>
</div>
</div>
</div>
</div>
