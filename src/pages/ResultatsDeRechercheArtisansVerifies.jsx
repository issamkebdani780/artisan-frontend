...
<h1 className="text-xl font-bold tracking-tight text-slate-900">Artisans Pro</h1>
</div>
<nav className="hidden md:flex items-center gap-6">
<a className="text-sm font-medium text-slate-600 hover:text-primary transition-colors" href="#">Accueil</a>
<a className="text-sm font-medium text-primary underline underline-offset-4" href="#">Artisans</a>
<a className="text-sm font-medium text-slate-600 hover:text-primary transition-colors" href="#">Tarifs</a>
</nav>
</div>
{/*  Search and Actions  */}
...
<input className="w-full bg-slate-100 border-none rounded-lg py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-primary/20 transition-all" placeholder="Rechercher un artisan..." type="text"/>
</div>
<div className="flex items-center gap-2">
...
<div className="h-8 w-8 rounded-full bg-primary/20 overflow-hidden ml-2 border border-slate-200">
...
<p className="text-xs text-slate-500">Affinez votre recherche</p>
</div>
...
{/*  Trust Banner  */}
<section className="bg-primary/5 rounded-xl border border-primary/20 p-6 flex flex-col md:flex-row items-center gap-6">
...
<p className="text-sm text-slate-500">Plomberie &amp; Chauffage</p>
</div>
...
<button className="p-2.5 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50">
...
<p className="text-sm text-slate-500">Menuiserie &amp; Agencement</p>
</div>
<div className="flex items-center gap-1 bg-amber-50 text-amber-600 px-2 py-1 rounded-lg text-sm font-bold">
<span className="material-symbols-outlined text-sm" >star</span>
                                    5.0
...
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-slate-200 hover:bg-slate-50">
<span className="material-symbols-outlined text-slate-400">chevron_left</span>
</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg bg-primary text-white font-bold">1</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-slate-200 hover:bg-slate-50">2</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-slate-200 hover:bg-slate-50">3</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-slate-200 hover:bg-slate-50">
