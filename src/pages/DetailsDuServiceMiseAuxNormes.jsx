...
const DetailsDuServiceMiseAuxNormes = () => {
  return (
    <>
...
{/*  Navigation  */}
<header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-orange-100 px-6 md:px-20 py-4 bg-white">
<div className="flex items-center gap-4 text-primary">
<div className="size-8">
<span className="material-symbols-outlined text-4xl">bolt</span>
</div>
<h2 className="text-slate-900 text-xl font-bold leading-tight tracking-tight">VoltExpert</h2>
</div>
...
<button className="flex items-center justify-center rounded-lg h-10 w-10 bg-orange-50 text-primary">
...
<div className="relative rounded-xl overflow-hidden min-h-[400px] flex flex-col justify-end p-8 bg-slate-900">
<div className="absolute inset-0 bg-cover bg-center opacity-60" data-alt="Electrician working on a modern electrical panel breaker box" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuDOcnbDxVrcRwgDDd4Ydu8yOQOE6XklbiiZN9oVkWyS_H-U2IAJvg7CGWGBg58hJEBki_6StvDhU0zQDhxG97doqLQuGVWRYOA-GhTpAiLu8z0Zkbr4JE_cjZQqgdRdXDsEZmtnnLNT4ylFVhKuuuqJKFAKQ0b6qasGXB3ay_AdPbVlXK-rP6YmDHQQQf1QjbvPHIr1I8gmcYp8rVxWlt0ou4LPFogo-u-ltZVDE3_25lznh4krTl0yp0xqTw3uD0KNoBY_3hXsXW9a");'></div>
...
<a className="text-slate-500 hover:text-primary" href="#">Accueil</a>
<span className="material-symbols-outlined text-sm text-slate-400">chevron_right</span>
<a className="text-slate-500 hover:text-primary" href="#">Services</a>
<span className="material-symbols-outlined text-sm text-slate-400">chevron_right</span>
<span className="text-primary font-semibold">Mise aux normes</span>
</div>
...
<p className="text-slate-500 text-sm">Interventions</p>
<p className="text-2xl font-bold">5000+</p>
</div>
<div className="bg-white p-6 rounded-xl border border-orange-100 shadow-sm">
<span className="material-symbols-outlined text-primary text-3xl mb-2">sentiment_satisfied</span>
...
<p className="text-slate-500 text-sm">Garantie</p>
<p className="text-2xl font-bold">10 ans</p>
</div>
</div>
<section className="space-y-6">
<h3 className="text-2xl font-bold">Nos services diagnostics &amp; travaux</h3>
<div className="space-y-4">
<div className="flex gap-4 p-4 rounded-xl bg-white border border-slate-100">
<div className="bg-orange-100 p-3 rounded-lg h-fit text-primary">
...
<p className="text-center mt-4 text-sm opacity-80">Sans engagement</p>
</div>
<div className="bg-white p-6 rounded-xl border border-slate-200">
<h4 className="font-bold text-lg mb-4">Certifications &amp; Engagement</h4>
...
{/*  Testimonial Section  */}
<section className="mt-20 py-12 border-t border-orange-100">
<h2 className="text-3xl font-black text-center mb-12">Ils nous font confiance</h2>
...
{/*  Footer  */}
<footer className="bg-stone-900 text-white px-6 md:px-20 py-12 mt-12">
...
<ul className="space-y-3 text-slate-400 text-sm">
<li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-sm">phone</span> 01 23 45 67 89</li>
<li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-sm">mail</span> contact@voltexpert.fr</li>
<li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-sm">location_on</span> 75008 Paris, France</li>
</ul>
</div>
</div>
...
export default DetailsDuServiceMiseAuxNormes;
