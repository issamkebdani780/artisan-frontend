...
<div className="relative overflow-hidden rounded-xl aspect-[21/9] flex items-end">
...
<span className="material-symbols-outlined text-sm">star</span>
<span className="material-symbols-outlined text-sm">star</span>
<span className="text-xs ml-1 font-bold">4.9</span>
</div>
</div>
...
<span className="text-xs ml-1 font-bold">4.7</span>
</div>
</div>
<button className="text-primary hover:text-primary/70">
<span className="material-symbols-outlined">chat</span>
...
<div>
<p className="text-xs text-slate-400 font-bold uppercase tracking-wider">Ligne Directe</p>
