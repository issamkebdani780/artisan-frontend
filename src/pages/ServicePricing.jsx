    ...
    <div className="flex-grow pt-8 pb-24">
      <section className="max-w-7xl mx-auto px-4 lg:px-20 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          ...
          <div className="group flex flex-col rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-8 shadow-sm transition-all hover:shadow-xl hover:border-blue-600/50">
            ...
            <Link to="/request-quote" className="w-full inline-flex justify-center items-center rounded-xl bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 py-3 font-bold transition-all group-hover:bg-blue-600 group-hover:text-white">
              Demander un devis
            </Link>
          </div>

          <div className="group flex flex-col rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-8 shadow-sm transition-all hover:shadow-xl hover:border-yellow-500/50">
            <div className="mb-6 flex items-center justify-between">
            ...
            <Link to="/request-quote" className="w-full inline-flex justify-center items-center rounded-xl bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 py-3 font-bold transition-all group-hover:bg-yellow-500 group-hover:text-white">
              Demander un devis
            </Link>
          </div>

          <div className="group flex flex-col rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-8 shadow-sm transition-all hover:shadow-xl hover:border-emerald-500/50 relative overflow-hidden">
            ...
            <div className="mb-8">
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-slate-500 font-medium">par m²</span>
              </div>
            </div>
            <ul className="flex-grow space-y-4 mb-8">
              <li className="flex items-center gap-3 text-slate-600 dark:text-slate-300">
            ...
            <Link to="/request-quote" className="w-full inline-flex justify-center items-center rounded-xl bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 py-3 font-bold transition-all group-hover:bg-emerald-500 group-hover:text-white">
              Demander un devis
            </Link>
          </div>
          
          <div className="group flex flex-col rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-8 shadow-sm transition-all hover:shadow-xl hover:border-purple-500/50">
            <div className="mb-6 flex items-center justify-between">
            ...
            <Link to="/request-quote" className="w-full inline-flex justify-center items-center rounded-xl bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 py-3 font-bold transition-all group-hover:bg-purple-500 group-hover:text-white">
              Demander un devis
            </Link>
          </div>
          
          <div className="group flex flex-col rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-8 shadow-sm transition-all hover:shadow-xl hover:border-[#ec5b13]/50 relative overflow-hidden">
            ...
            <Link to="/request-quote" className="w-full inline-flex justify-center items-center rounded-xl bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 py-3 font-bold transition-all group-hover:bg-[#ec5b13] group-hover:text-white">
              Demander un devis
            </Link>
          </div>
          
          <div className="grow flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-slate-300 dark:border-slate-700 p-8 text-center bg-transparent group hover:border-blue-600 transition-colors cursor-pointer">
      ...
      <section className="bg-white dark:bg-slate-900 py-20 px-4 border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12 text-center md:text-left">
            <div className="flex flex-col items-center md:items-start group">
              <div className="size-16 rounded-2xl bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center shadow-inner mb-6 text-blue-600 group-hover:scale-110 transition-transform">
                <span className="material-symbols-outlined text-3xl">priority_high</span>
              </div>
              <h4 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">Urgences & Horaires</h4>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">Les interventions de nuit, le week-end ou les jours fériés peuvent inclure une majoration de 20% à 50% selon l'artisan.</p>
            </div>
            <div className="flex flex-col items-center md:items-start group">
              <div className="size-16 rounded-2xl bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center shadow-inner mb-6 text-blue-600 group-hover:scale-110 transition-transform">
                <span className="material-symbols-outlined text-3xl">inventory_2</span>
              </div>
              <h4 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">Matériel & Fournitures</h4>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">Le coût des matériaux (peinture, pièces de plomberie, etc.) est généralement facturé en sus du coût horaire ou forfaitaire de la main-d'œuvre.</p>
            </div>
            <div className="flex flex-col items-center md:items-start group">
              <div className="size-16 rounded-2xl bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center shadow-inner mb-6 text-blue-600 group-hover:scale-110 transition-transform">
                <span className="material-symbols-outlined text-3xl">account_tree</span>
              </div>
              <h4 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">Complexité</h4>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">La difficulté d'accès ou l'âge de l'installation peuvent modifier le volume d'heures requises. Chaque devis est 100% personnalisé.</p>
            </div>
          </div>
        </div>
      </section>
