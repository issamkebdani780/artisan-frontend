    ...
    <div className="flex-grow pt-8 pb-24">
      <section className="max-w-7xl mx-auto px-4 lg:px-20 py-12 lg:py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-lg lg:text-xl text-slate-600 max-w-2xl mx-auto">
            DÃ©couvrez nos tarifs de base pour vos travaux Ã  domicile. Nous prÃ´nons la transparence et des prix justes pour chaque intervention.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          ...
          <div className="group flex flex-col rounded-3xl border border-slate-200 bg-white p-8 shadow-sm transition-all hover:shadow-xl hover:border-blue-600/50">
            ...
            <div className="mb-8">
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-slate-500 font-medium">dÃ¨s</span>
              </div>
            </div>
          ...
          <div className="group flex flex-col rounded-3xl border border-slate-200 bg-white p-8 shadow-sm transition-all hover:shadow-xl hover:border-[#ec5b13]/50 relative overflow-hidden">
            <div className="absolute top-4 -right-10 bg-[#ec5b13] text-white text-xs font-bold px-10 py-1 rotate-45 shadow-sm">BientÃ´t Complet</div>
            <div className="mb-6 flex items-center justify-between">
            ...
            <ul className="flex-grow space-y-4 mb-8">
              ...
              <li className="flex items-center gap-3 text-slate-600">
                <span className="material-symbols-outlined text-[#ec5b13] text-xl">check_circle</span>
                <span>Fixation murale (TV, Ã©tagÃ¨re)</span>
              </li>
              <li className="flex items-center gap-3 text-slate-600">
                <span className="material-symbols-outlined text-[#ec5b13] text-xl">check_circle</span>
                <span>Pose de tringles Ã  rideaux</span>
              </li>
            </ul>
          ...
          <div className="grow flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-slate-300 p-8 text-center bg-transparent group hover:border-blue-600 transition-colors cursor-pointer">
            ...
            <p className="text-slate-500 mb-6">Jardinage, serrurerie, maÃ§onnerie... nous vous mettons en relation avec le bon artisan.</p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12 text-center md:text-left">
            <div className="flex flex-col items-center md:items-start group">
              ...
              <p className="text-slate-600 leading-relaxed">Les interventions de nuit, le week-end ou les jours fÃ©riÃ©s peuvent inclure une majoration de 20% Ã  50% selon l'artisan.</p>
            </div>
            <div className="flex flex-col items-center md:items-start group">
              <div className="size-16 rounded-2xl bg-blue-50 flex items-center justify-center shadow-inner mb-6 text-blue-600 group-hover:scale-110 transition-transform">
                <span className="material-symbols-outlined text-3xl">inventory_2</span>
              </div>
              <h4 className="text-xl font-bold mb-3 text-slate-900">MatÃ©riel & Fournitures</h4>
              <p className="text-slate-600 leading-relaxed">Le coÃ»t des matÃ©riaux (peinture, piÃ¨ces de plomberie, etc.) est gÃ©nÃ©ralement facturÃ© en sus du coÃ»t horaire ou forfaitaire de la main-d'Å“uvre.</p>
            </div>
            <div className="flex flex-col items-center md:items-start group">
              <div className="size-16 rounded-2xl bg-blue-50 flex items-center justify-center shadow-inner mb-6 text-blue-600 group-hover:scale-110 transition-transform">
                <span className="material-symbols-outlined text-3xl">account_tree</span>
              </div>
              <h4 className="text-xl font-bold mb-3 text-slate-900">ComplexitÃ©</h4>
              <p className="text-slate-600 leading-relaxed">La difficultÃ© d'accÃ¨s ou l'Ã¢ge de l'installation peuvent modifier le volume d'heures requises. Chaque devis est 100% personnalisÃ©.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 text-center max-w-5xl mx-auto">
        <div className="bg-blue-600 rounded-[2.5rem] p-12 lg:p-20 text-white relative overflow-hidden shadow-2xl">
          ...
          <p className="text-xl text-blue-100 mb-10 relative z-10 max-w-2xl mx-auto">Obtenez une estimation prÃ©cise et 100% gratuite pour vos travaux en moins de 24 heures.</p>
