...
<p className="text-slate-900 dark:text-slate-100 text-2xl font-bold">�DA partir de 45€ <span className="text-sm font-normal text-slate-500">/ prestation</span></p>
...
<p className="text-slate-600 dark:text-slate-400 text-sm">Mise en place de circuits neufs et rénovation complète de votre installation électrique.</p>
</div>
</div>
<div className="flex items-start gap-4 p-5 rounded-xl bg-primary/5 border border-primary/10">
<div className="bg-primary text-white p-3 rounded-lg">
...
<p className="text-slate-600 dark:text-slate-400 text-sm">Configuration de systèmes connectés, éclairages intelligents et sécurité.</p>
</div>
</div>
<div className="flex items-start gap-4 p-5 rounded-xl bg-primary/5 border border-primary/10">
<div className="bg-primary text-white p-3 rounded-lg">
...
<p className="text-slate-600 dark:text-slate-400 text-sm">Installation certifiée de bornes de recharge pour véhicules électriques.</p>
</div>
</div>
</div>
</section>
...
<div>
<h2 className="text-slate-900 dark:text-slate-100 text-3xl font-bold">Experts certifiés</h2>
<p className="text-slate-600 dark:text-slate-400 mt-2">Des professionnels passionnés près de chez vous.</p>
</div>
