...
<p className="text-slate-600 text-sm">Mise en place de circuits neufs et r̩novation compl̬te de votre installation ̩lectrique.</p>
</div>
</div>
<div className="flex items-start gap-4 p-5 rounded-xl bg-primary/5 border border-primary/10">
<div className="bg-primary text-white p-3 rounded-lg">
...
<p className="text-slate-600 text-sm">Configuration de syst̬mes connect̩s, ̩clairages intelligents et s̩curit̩.</p>
</div>
</div>
<div className="flex items-start gap-4 p-5 rounded-xl bg-primary/5 border border-primary/10">
<div className="bg-primary text-white p-3 rounded-lg">
...
<p className="text-slate-600 text-sm">Installation certifi̩e de bornes de recharge pour v̩hicules ̩lectriques.</p>
</div>
</div>
</div>
</section>
...
<div>
<h2 className="text-slate-900 text-3xl font-bold">Experts certifi̩s</h2>
<p className="text-slate-600 mt-2">Des professionnels passionn̩s pr̬s de chez vous.</p>
</div>
