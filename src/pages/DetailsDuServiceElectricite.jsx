...
<h2 className="text-slate-900 dark:text-slate-100 text-lg font-bold leading-tight tracking-tight">ArtisanPro</h2>
</div>
...
<a className="text-slate-700 dark:text-slate-300 text-sm font-medium hover:text-primary transition-colors" href="#">RÃ©alisations</a>
<a className="text-slate-700 dark:text-slate-300 text-sm font-medium hover:text-primary transition-colors" href="#">Blog</a>
...
<h1 className="text-white text-4xl md:text-5xl font-black leading-tight tracking-tight">DÃ©pannage et Installation Ã‰lectrique</h1>
...
<p className="text-slate-900 dark:text-slate-100 text-2xl font-bold">ÃDA partir de 45â‚¬ <span className="text-sm font-normal text-slate-500">/ prestation</span></p>
<div className="flex items-center gap-2">
<span className="material-symbols-outlined text-primary text-sm">verified_user</span>
<p className="text-slate-600 dark:text-slate-400 text-sm">Assurance responsabilitÃ© civile incluse</p>
</div>
</div>
...
<p className="text-slate-900 dark:text-slate-100 text-2xl font-bold">Sous 2-4h</p>
</div>
<div className="flex flex-col gap-2 rounded-xl p-6 border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50">
<span className="material-symbols-outlined text-primary">star</span>
<p className="text-slate-500 text-sm font-medium uppercase tracking-wider">Satisfaction Client</p>
<p className="text-slate-900 dark:text-slate-100 text-2xl font-bold">4.9/5 (2.5k avis)</p>
</div>
<div className="flex flex-col gap-2 rounded-xl p-6 border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50">
...
<h2 className="text-slate-900 dark:text-slate-100 text-3xl font-bold mb-8">Nos Expertises SpÃ©cialisÃ©es</h2>
...
<div>
<h3 className="text-lg font-bold mb-1">Installation &amp; RÃ©novation</h3>
<p className="text-slate-600 dark:text-slate-400 text-sm">Mise en place de circuits neufs et rÃ©novation complÃ¨te de votre installation Ã©lectrique.</p>
</div>
</div>
<div className="flex items-start gap-4 p-5 rounded-xl bg-primary/5 border border-primary/10">
<div className="bg-primary text-white p-3 rounded-lg">
...
<div>
<h3 className="text-lg font-bold mb-1">DÃ©pannage Urgent</h3>
<p className="text-slate-600 dark:text-slate-400 text-sm">Recherche de pannes, courts-circuits et coupures de courant 24j/7.</p>
</div>
</div>
<div className="flex items-start gap-4 p-5 rounded-xl bg-primary/5 border border-primary/10">
<div className="bg-primary text-white p-3 rounded-lg">
...
<div>
<h3 className="text-lg font-bold mb-1">Domotique &amp; ConnectÃ©</h3>
<p className="text-slate-600 dark:text-slate-400 text-sm">Configuration de systÃ¨mes connectÃ©s, Ã©clairages intelligents et sÃ©curitÃ©.</p>
</div>
</div>
<div className="flex items-start gap-4 p-5 rounded-xl bg-primary/5 border border-primary/10">
<div className="bg-primary text-white p-3 rounded-lg">
...
<p className="text-slate-600 dark:text-slate-400 text-sm">Installation certifiÃ©e de bornes de recharge pour vÃ©hicules Ã©lectriques.</p>
</div>
</div>
</div>
</section>
...
<p className="text-sm text-slate-300 mb-4">Nos Ã©lectriciens sont certifiÃ©s Qualifelec et Ã  votre disposition.</p>
...
<div>
<h2 className="text-slate-900 dark:text-slate-100 text-3xl font-bold">Experts certifiÃ©s</h2>
<p className="text-slate-600 dark:text-slate-400 mt-2">Des professionnels passionnÃ©s prÃ¨s de chez vous.</p>
</div>
...
<p className="text-slate-500 text-sm mb-4">Ã‰lectricien certifiÃ© - 15 ans d'exp.</p>
...
<p className="text-slate-500 text-sm mb-4">Expert DÃ©pannage Urgent</p>
<div className="flex items-center gap-1 text-primary mb-4">
<span className="material-symbols-outlined text-sm">star</span>
<span className="material-symbols-outlined text-sm">star</span>
<span className="material-symbols-outlined text-sm">star</span>
...
<p className="text-slate-500 text-sm mb-4">SpÃ©cialiste Installation Neuve</p>
<div className="flex items-center gap-1 text-primary mb-4">
<span className="material-symbols-outlined text-sm">star</span>
<span className="material-symbols-outlined text-sm">star</span>
<span className="material-symbols-outlined text-sm">star</span>
...
<tr>
<td className="p-4">Diagnostic &amp; RÃ©paration standard</td>
...
<p className="mt-4 text-sm text-slate-500 text-center italic">* Les tarifs peuvent varier selon la complexitÃ© et l'Ã©tat de l'installation.</p>
</section>
</div></main>
{/*  Footer  */}
...
<span className="font-bold text-lg text-slate-900 dark:text-slate-100">ArtisanPro</span>
</div>
...
<div className="max-w-[1024px] mx-auto mt-12 pt-8 border-t border-slate-100 dark:border-slate-800 text-center text-xs text-slate-400">
                    Â© 2024 ArtisanPro. Tous droits rÃ©servÃ©s.
                </div>
</footer>
</div>
