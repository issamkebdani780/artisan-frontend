...
<h2 className="text-lg font-bold tracking-tight">Khadamati PRO</h2>
</div>
...
<p className="text-slate-500 text-xs">Compte Professionnel</p>
</div>
</div>
...
<input className="w-full bg-slate-100 border-none rounded-xl pl-10 pr-4 py-2 text-sm focus:ring-2 focus:ring-primary/50 transition-all outline-none" placeholder="Rechercher un dossier ou un client..." type="text"/>
</div>
</div>
...
<button className="p-2 text-slate-600 hover:bg-slate-100 rounded-lg" onclick="document.documentElement.classList.toggle('dark')">
...
<span className="p-2 bg-red-100 text-red-600 rounded-lg material-symbols-outlined">error</span>
...
<div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
<div className="flex items-center justify-between mb-4">
<span className="p-2 bg-orange-100 text-orange-600 rounded-lg material-symbols-outlined">warning</span>
...
<div className="flex flex-col">
<span className="font-semibold text-slate-900">Jean Dupont</span>
...
<td className="px-6 py-5">
<p className="text-sm text-slate-600 line-clamp-1">Dommage mineur sur l'angle gauche lors du transport.</p>
</td>
<td className="px-6 py-5">
