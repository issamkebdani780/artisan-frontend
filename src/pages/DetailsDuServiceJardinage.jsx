...
const DetailsDuServiceJardinage = () => {
  return (
    <>
      
<div className="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden">
<div className="layout-container flex h-full grow flex-col">
<header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 dark:border-slate-800 bg-white dark:bg-background-dark px-6 md:px-40 py-3 sticky top-0 z-50">
<div className="flex items-center gap-8">
<div className="flex items-center gap-4 text-primary">
<div className="size-6 flex items-center justify-center">
<span className="material-symbols-outlined text-3xl">potted_plant</span>
</div>
<h2 className="text-slate-900 dark:text-slate-100 text-lg font-bold leading-tight tracking-[-0.015em]">JardinagePro</h2>
</div>
...
<a className="text-slate-700 dark:text-slate-300 text-sm font-medium hover:text-primary transition-colors" href="#">Jardiniers</a>
<a className="text-slate-700 dark:text-slate-300 text-sm font-medium hover:text-primary transition-colors" href="#">Aide</a>
</div>
</div>
...
<input className="form-input flex w-full min-w-0 flex-1 border-none bg-slate-100 dark:bg-slate-800 focus:ring-0 h-full placeholder:text-slate-500 px-4 rounded-r-lg text-sm" placeholder="Rechercher un service" value=""/>
</div>
</label>
<div className="flex gap-2">
<button className="flex items-center justify-center rounded-lg h-10 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-100 px-3 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
...
<button className="w-full py-3 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-100 font-bold rounded-lg hover:bg-primary hover:text-white transition-colors">Choisir ce plan</button>
</div>
</div>
<div className="flex flex-col rounded-xl border-2 border-primary bg-white dark:bg-slate-900 overflow-hidden shadow-lg relative transform scale-105 z-10">
...
<div className="p-8 pt-0">
<button className="w-full py-3 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-100 font-bold rounded-lg hover:bg-primary hover:text-white transition-colors">Demander un devis</button>
</div>
</div>
</div>
</section>
<section className="px-4 md:px-40 py-16 bg-slate-100 dark:bg-slate-900/40">
<h2 className="text-slate-900 dark:text-slate-100 text-2xl md:text-3xl font-bold mb-8">Nos meilleurs jardiniers</h2>
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
...
<footer className="px-6 md:px-40 py-12 bg-white dark:bg-background-dark border-t border-slate-200 dark:border-slate-800">
...
<p className="text-sm text-slate-500 dark:text-slate-400 mb-4">Recevez nos conseils de saison.</p>
<div className="flex gap-2">
<input className="form-input flex-1 bg-slate-100 dark:bg-slate-800 border-none rounded-lg text-sm" placeholder="Votre email" type="email"/>
...
export default DetailsDuServiceJardinage;
