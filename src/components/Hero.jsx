...
const Hero = () => {
  ...
  return (
    <div className="w-full px-6 md:px-20 py-12 md:py-20 bg-white">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 text-left space-y-8">
          ...
          <div className="flex flex-col sm:flex-row w-full max-w-2xl bg-white rounded-3xl p-3 shadow-2xl shadow-primary/10 border border-slate-100">
        ...
        <div className="flex-1 relative hidden lg:block">
          ...
          <img 
            ...
            alt="Artisan at work" 
            className="relative rounded-[50px] shadow-2xl border-8 border-white object-cover aspect-4/5 w-full"
          />
          <div className="absolute -bottom-8 -left-8 bg-white p-6 rounded-3xl shadow-xl border border-slate-50 flex items-center gap-4 animate-bounce-slow">
