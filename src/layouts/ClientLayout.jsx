...
const ClientLayout = ({ children, title = "Khadamati Client", subtitle = "Tableau de bord" }) => {
        ...
        <header className={`h-24 bg-white/80 backdrop-blur-md border-b border-slate-50 px-8 flex items-center justify-between fixed ${headerLeft} left-0 right-0 top-0 z-50 shrink-0 transition-all duration-300 shadow-sm`}>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-4 pl-2 font-['Outfit',sans-serif]">
              ...
              <div className="size-12 rounded-2xl bg-white p-1 border border-slate-100 shadow-xl shadow-slate-200/50 shrink-0 flex items-center justify-center text-primary font-black transition-all group-hover:scale-105">
