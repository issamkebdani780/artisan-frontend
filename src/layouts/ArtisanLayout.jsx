          ...
          <div className="flex items-center justify-between">
            <div className={`flex items-center gap-4 transition-all duration-300 ${isCollapsed ? 'lg:opacity-0 lg:scale-0 lg:w-0' : 'opacity-100 scale-100'}`}>
              ...
              <div className="flex flex-col min-w-0">
                ...
                <p className={`${Number(currentUser?.is_verified) === 1 ? 'text-secondary' : Number(currentUser?.is_verified) === -1 ? 'text-red-500' : 'text-slate-400'} text-[10px] font-black uppercase tracking-widest truncate overflow-hidden mt-0.5`}>
